...
Begin VB.Form frmTermsMaint 
   ...
   Begin VB.Frame fraTerms 
      ...
      Begin SPELLCHECKERLibCtl.SpellChecker SpellChecker1 
         Left            =   6450
         OleObjectBlob   =   "frmTermsMaint.frx":058A
         Top             =   900
      End
      Begin PT_XP_Button.PT_XP cmdAdd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTermsMaint.frx":05AE
         AppearanceThemes=   3
         ...
         PictureDisabled =   "frmTermsMaint.frx":0B48
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdUp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTermsMaint.frx":0E9A
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmTermsMaint.frx":1614
         PictureAlignment=   4
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdDown 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTermsMaint.frx":1D26
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmTermsMaint.frx":24A0
         PictureAlignment=   4
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdReplace 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTermsMaint.frx":2BB2
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Replace"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmTermsMaint.frx":314C
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRemove 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTermsMaint.frx":349E
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Remove"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmTermsMaint.frx":3A38
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdCheckComment 
         ...
         EndProperty
         MaskColor       =   128
         Picture         =   "frmTermsMaint.frx":3D8A
         AppearanceThemes=   3
         BorderWidth     =   2
         TransparentColor=   14737632
         Caption         =   ""
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmTermsMaint.frx":4324
         PictureAlignment=   4
         ShowFocus       =   -1  'True
      End
   End
   Begin PT_XP_Button.PT_XP cmdSave 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmTermsMaint.frx":4676
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Save"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmTermsMaint.frx":4A10
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdDone 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmTermsMaint.frx":4D62
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Close"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmTermsMaint.frx":5774
      ShowFocus       =   -1  'True
   End
End
Attribute VB_Name = "frmTermsMaint"
...
Dim Idx As Integer
    ...
    Screen.MousePointer = vbHourglass
        ...
        For Idx = 0 To lstTerms.listcount - 1
            'Call stored procedure to save row value
            cn.A_ATT_ATTR_VALID_VALUE "X", fSubDomain, Idx + 1, lstTerms.List(Idx), Null
        Next Idx
            
        'Call stored procedure to delete row excess
