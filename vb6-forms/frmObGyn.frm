...
Begin VB.Form frmObGyn 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0E0E0&
   Caption         =   "IVF - Gynecology Clinical Data"
   ClientHeight    =   11490
   ClientLeft      =   5760
   ClientTop       =   2760
   ClientWidth     =   14175
...
Dim Arr
    ...
    Set fobjOCX = Controls.Add(strOCX & "." & strControl, "ctl" & strControl, Me)
        ...
        frmObGyn.Width = fobjOCX.Width + 300
