...
Begin VB.Form frmSchedResource 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "frmSchedResource.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9840
   ScaleMode       =   0  'User
   ScaleWidth      =   13365
   ...
   Begin VB.Frame fraChange 
      ...
      Begin LpADOLib.fpComboAdo fpTerm 
         ...
         EditAlignV      =   0
         AllowAnimate    =   -1  'True
         ColDesigner     =   "frmSchedResource.frx":058A
      End
      Begin PT_XP_Button.PT_XP cmdRemoveRow 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":084D
         AppearanceThemes=   3
         ...
         PictureDisabled =   "frmSchedResource.frx":0DE7
         ShowFocus       =   -1  'True
      End
      Begin FPSpreadADO.fpSpread grdAppointChange 
         ...
         ShadowDark      =   8388608
         ShadowText      =   0
         SpreadDesigner  =   "frmSchedResource.frx":1139
         UserResize      =   0
         Appearance      =   1
         ClipboardOptions=   0
         CellNoteIndicator=   3
      ...
      Begin PT_XP_Button.PT_XP cmdUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":1616
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":1BB0
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdFrameClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":1F02
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":2914
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":2C66
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Print"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":3200
         ShowFocus       =   -1  'True
      End
   ...
   Begin VB.ComboBox cboFacility 
      ...
      ForeColor       =   &H00000000&
      Height          =   300
      ItemData        =   "frmSchedResource.frx":3552
      Left            =   6060
      List            =   "frmSchedResource.frx":3554
   ...
   Begin VB.ComboBox cboApptType 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmSchedResource.frx":3556
      Left            =   2010
      List            =   "frmSchedResource.frx":3569
      Style           =   2  'Dropdown List
      TabIndex        =   64
      Top             =   765
      Width           =   2970
   ...
   Begin PT_XP_Button.PT_XP cmdEditPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":359C
      AppearanceThemes=   3
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":3B36
      ShowFocus       =   -1  'True
   End
   ...
   Begin PT_XP_Button.PT_XP cmdTakePic 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":3E88
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmSchedResource.frx":4762
      ShowFocus       =   -1  'True
   End
   ...
   Begin PT_XP_Button.PT_XP cmdClose 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":53B4
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Close"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":5DC6
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdApply 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":6118
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "&Apply"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":64B2
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdNewPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":6804
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "New Patient"
      CaptionAlignment=   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":6D9E
      ShowFocus       =   -1  'True
   End
   Begin VB.Frame fraInfo 
      ...
      Begin VB.Frame fraRefer 
         ...
         Begin PT_XP_Button.PT_XP cmdRefClose 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedResource.frx":70F0
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close "
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedResource.frx":7B02
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdRefTerms 
            ...
            EndProperty
            MaskColor       =   128
            Picture         =   "frmSchedResource.frx":7E54
            AppearanceThemes=   3
            BorderWidth     =   2
            TransparentColor=   14737632
            Caption         =   ".."
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedResource.frx":83EE
            ShowFocus       =   -1  'True
         End
      ...
      Begin VB.ComboBox cboReferBy 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "frmSchedResource.frx":8740
         Left            =   8925
         List            =   "frmSchedResource.frx":8742
         Style           =   2  'Dropdown List
         TabIndex        =   57
         Top             =   3510
         Width           =   2865
      ...
      Begin VB.ComboBox cboSerPlace 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmSchedResource.frx":8744
         Left            =   2595
         List            =   "frmSchedResource.frx":8746
         Style           =   2  'Dropdown List
         TabIndex        =   43
      ...
      Begin PT_XP_Button.PT_XP cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":8748
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close Me"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":915A
         PictureAlignment=   6
         ShowFocus       =   -1  'True
      End
      ...
      Begin VB.ComboBox cboStatus 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmSchedResource.frx":94AC
         Left            =   9420
         List            =   "frmSchedResource.frx":94AE
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1950
         Width           =   3285
      ...
      Begin PT_XP_Button.PT_XP cmdStatus 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":94B0
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedResource.frx":9A4A
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":9D9C
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedResource.frx":A336
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRefReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":A688
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedResource.frx":AC22
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdChange 
         ...
         EndProperty
         MaskColor       =   128
         Picture         =   "frmSchedResource.frx":AF74
         AppearanceThemes=   3
         BorderWidth     =   2
         TransparentColor=   14737632
         Caption         =   ""
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":B50E
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRepeat 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":B860
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":BDFA
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdShowAll 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedResource.frx":C14C
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedResource.frx":C6E6
         ShowFocus       =   -1  'True
      End
   ...
   Begin PT_XP_Button.PT_XP cmdAcct 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":CA38
      AppearanceThemes=   3
      BorderDrawEvent =   1
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":CFD2
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdChangeUser 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":D324
      AppearanceThemes=   3
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":D8BE
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdReferral 
      Height          =   435
      Left            =   1620
      TabIndex        =   89
      Top             =   30
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":DC10
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Referrals"
      Depth           =   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":E1AA
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdNewPat 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":E4FC
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "New Patient"
      CaptionAlignment=   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":EA96
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdMedication 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":EDE8
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Medication"
      Depth           =   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":F382
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdDx 
      Height          =   435
      Left            =   4950
      TabIndex        =   92
      Top             =   30
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedResource.frx":F6D4
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Diagnosis"
      Depth           =   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedResource.frx":FC6E
      ShowFocus       =   -1  'True
   End
   ...
   End
End
Attribute VB_Name = "frmSchedResource"
...
Dim lngFacID As Long
    ...
    strSQL = "SELECT b.*, a.PROVIDER_ID from APPOINTMENT_PROVIDERS a, PROVIDERS b " _
        & "where a.FACILITY_ID = " & udtFacility.FacID & " and b.PROVIDER_ID = a.PROVIDER_ID and b.ACTIVE = 1 ORDER BY b.LAST_NAME, b.FIRST_NAME"
...
Dim strTerms As String
    ...
    strSQL = "SELECT * FROM ATTR_VALID_VALUE WHERE VALID_VALUE_SUBDOM = 'sd_Appointment_Status' ORDER BY  VALID_VALUE_SEQ_NBR"
...
Dim rsAppt As New ADODB.Recordset
    ...
    strSQL = "SELECT DISTINCT APPT_TIME FROM APPOINTMENT_TYPE ORDER BY APPT_TIME"
...
Dim lngFacID As Long
    ...
    If Trim(vstrType) <> vbNullString Then
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE , PROVIDER_TITLE FROM APPOINTMENT_TYPE WHERE " _
            & "VISIT_TYPE like '" & vstrType & "%'  ORDER BY APPT_CODE"
    Else
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE , PROVIDER_TITLE FROM APPOINTMENT_TYPE  WHERE " _
            & "FACILITY_ID = " & lngFacID & " ORDER BY PROVIDER_TITLE,APPT_CODE"
    End If
...
Dim Idx%
    ...
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(0)
        strSQL = "SELECT APPT_ID FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND  PROVIDER_ID = " & udtAppointment.ProviderID & " And FACILITY_ID = " & udtAppointment.FacilityID & " AND " _
                & "CONVERT(VARCHAR, APPT_DATE , 10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND ACTIVE = 1 AND CONVERT(DATETIME, APPT_TIME,108)  = '" & Format(udtAppointment.SchedTime, "hh:mm AM/PM") & "'"
        Set rsAppt = cnAppt.Execute(strSQL)
        With rsAppt
            If Not .EOF Then
                Is_NewAppt = True
    ...
    Select Case UCase(clsApptPref.SchedInterval)
       ...
       Case "EVERY 5 MIN"
           Load_TimeGrid = "07:00 AM" & Chr(9) & "07:05 AM" & Chr(9) & "07:10 AM" & Chr(9) & "07:15 AM" & Chr(9) & "07:20 AM" & Chr(9) & "07:25 AM" & Chr(9) & "07:30 AM" & Chr(9) & "07:35 AM" _
             ...
             & "01:00 PM" & Chr(9) & "01:05 PM" & Chr(9) & "01:10 PM" & Chr(9) & "01:15 PM" _
...
Dim lngApptID As Long
    ...
    strSQL = "SELECT  * FROM APPOINTMENTS " _
        & "WHERE CONVERT(VARCHAR, APPT_DATE, 10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND " _
        & "FACILITY_ID = " & lngFacilityID & " AND " _
        & "PROVIDER_ID = " & udtAppointment.ProviderID & " AND " _
        & "PATIENT_ID = " & lngPatientID & " AND ACTIVE = 0 ORDER BY  APPT_TIME DESC"
        ...
        End With
    If lngApptID > 0 Then
        strSQL = "SELECT  * FROM APPOINTMENTS WHERE APPT_ID = " & lngApptID
        Set rsSched = cnSched.Execute(strSQL)
        With rsSched
            If Not .EOF Then
                Set Flds = .Fields
...
Dim lngDateDiff As Long
    ...
    Screen.MousePointer = vbHourglass
    If cnSched.State = adStateClosed Then cnSched.open psConnect(0)
    strSQL = "SELECT * FROM PATIENT_REPEAT_APPT WHERE FACILITY_ID = " & vlngFacility & " AND " _
            & "PROVIDER_ID = " & vlngProvider & " AND  PATIENT_ID = " & Val(udtSchedPatient.IntId)
        Set rsSched = cnSched.Execute(strSQL)
         With rsSched
            Do Until .EOF
                lngDateDiff = 0
...
Dim Arr
    ...
    If IsNumeric(vstrData) Then
        strSQL = "SELECT PATIENT_ID FROM PATIENT WHERE PATIENT_ID like  '" & vstrData & "%' Order by Last_Name"
        Set rsSearch = cnSearch.Execute(strSQL)
        If rsSearch.EOF Then
            strSQL = "SELECT PATIENT_ID FROM PATIENT WHERE  PATIENT_EXT_REF  LIKE '%" & vstrData & "%' Order by Last_Name"
            Set rsSearch = cnSearch.Execute(strSQL)
            With rsSearch
    ...
    Else
        If Trim(strFirst) <> vbNullString Then
             strSQL = "SELECT * FROM PATIENT WHERE  LAST_NAME " _
                & "like '" & strList & "%' AND FIRST_NAME like '%" & strFirst & "%' ORDER BY  LAST_NAME,  FIRST_NAME"
        Else
            strSQL = "SELECT * FROM PATIENT WHERE  LAST_NAME " _
                & "like '" & strList & "%' ORDER BY LAST_NAME, FIRST_NAME"
        End If
        Set rsSearch = cnSearch.Execute(strSQL)
            With rsSearch
                Do Until .EOF
...
Dim rsRef As New ADODB.Recordset
    ...
    If clsReferral.ReferralID = 0 Then
            strSQL = "SELECT REFERRAL_ID,REFERRAL_REASON FROM APPOINTMENTS WHERE " _
                & "PATIENT_ID = " & Val(udtSchedPatient.IntId) & " ORDER BY APPT_DATE DESC"
...
Dim sToday As String
    ...
    strSQL = "Select APPT_ID from APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
        & "CONVERT(DATETIME, APPT_TIME,108) = '" & Format(mstrOrigApptTime, "hh:mm AM/PM") & "'  AND " _
        & "CONVERT(VARCHAR, APPT_DATE , 10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND ACTIVE = 1"
    Set rsAppt = cnAppt.Execute(strSQL)
    ...
    If lngApptID > 0 Then
        strSQL = "UPDATE APPOINTMENTS SET ACTIVE = 0, STATUS = 'Rescheduled', REASON =  '" & strReason & "', NOTES = '" & strNotes & "'," _
            & "UPDATE_DATE = '" & sToday & "' WHERE APPT_ID = " & lngApptID
        Set rsAppt = cnAppt.Execute(strSQL)
...
Dim lngApptID As Long
    ...
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(0)
    strSQL = "SELECT APPT_ID FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
        & "PROVIDER_ID = " & udtAppointment.ProviderID & " And FACILITY_ID = " & udtAppointment.FacilityID & " AND " _
        & "CONVERT(varchar, APPT_DATE,10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND APPT_TIME = '" & udtAppointment.SchedTime & "' AND APPT_TYPE = '" & udtAppointment.SchedType & "' "
    Set rsAppt = cnAppt.Execute(strSQL)
'    strSQL = "SELECT APPT_ID FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
'        & "PROVIDER_ID = " & udtAppointment.ProviderID & " And FACILITY_ID = " & udtAppointment.FacilityID & " AND " _
'        & "CONVERT(VARCHAR, APPT_DATE , 10) = '" & udtAppointment.SchedDate & "' AND APPT_TYPE = '" & udtAppointment.SchedType & "' "
    Set rsAppt = cnAppt.Execute(strSQL)
    With rsAppt
        If Not .EOF Then
    ...
    If lngApptID > 0 Then
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(0)
        strSQL = "Update Appointments set Active = 0, Status = 'Cancelled', Reason =  '" & strReason & "', Notes = '" & strNotes & "'," _
                & "UPDATE_DATE = '" & strNow & "' WHERE APPT_ID  = " & lngApptID
            Set rsAppt = cnAppt.Execute(strSQL)
...
Dim lngEnctID As Long



    On Error GoTo Error_Check_Visit
    Screen.MousePointer = vbHourglass
    strStart = Format(udtAppointment.SchedDate, "mm/dd/yyyy 00:00:00 AM/PM")
    strEnd = Format(udtAppointment.SchedDate, "mm/dd/yyyy 00:00:00 AM/PM")
    strEnd = DateAdd("h", 23, strEnd)
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(0)
     If cnAppt.State = adStateOpen Then
        cnAppt.Close
        Set cnAppt = Nothing
...
Error_Check_Visit:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Check_Visit", App.EXEName & "." & TypeName(Me)
    Exit Function
    Resume
End Function
...
Dim strEndDate As String
    ...
    Else
        ...
        If Validate_ProvAppt = False Then
           strWeekDay = Weekday_Return(Weekday(udtAppointment.SchedDate))
            strSQL = "SELECT START_TIME, END_TIME, START_DATE, END_DATE FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtAppointment.ProviderID & " AND " _
                ...
                & "ACTIVE = 1 AND DAYWEEK = '" & strWeekDay & "' AND  CONVERT(VARCHAR, START_DATE, 10)  > '" & Format(strStartDate, "mm/dd/yyyy") & "' AND CONVERT(VARCHAR, START_DATE, 10) < '" & Format(strEndDate, "mm/dd/yyyy") & "' And " _
                & "CONVERT(VARCHAR, END_DATE, 10) < '" & Format(strEndDate, "mm/dd/yyyy") & "'  ORDER BY START_TIME DESC"
                 Set rsTerms = cnTerms.Execute(strSQL)
                With rsTerms
                    Clear_Block
        ...
        '                        If Format(strFoundStart, "hh:mm AM/PM") <= Format(vstrAppt_Time, "hh:mm AM/PM") And Format(strFoundStart, "hh:mm AM/PM") <= Format(strEnd, "hh:mm AM/PM") Then
                            Validate_ProvAppt = True
                            MsgBox "Provider has this time period permanently blocked, time is blocked from" & " " & strFoundStart & " " & "until" & " " & strFoundEnd
                            Exit Do
                        End If
        ...
        strSQL = "SELECT START_TIME, END_TIME FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtAppointment.ProviderID & " AND DAYWEEK = '' AND " _
            ...
            & "CONVERT(VARCHAR, END_DATE, 10) < '" & Format(strEndDate, "mm/dd/yyyy") & "'  ORDER BY START_TIME DESC"
                ...
                End With
        End If
        '5th Case Permanenent Permanent no day of week
        strStartDate = DateAdd("d", -1, Format(udtAppointment.SchedDate, "mm/dd/yyyy"))
        strEndDate = DateAdd("d", 1, Format(udtAppointment.SchedDate, "mm/dd/yyyy"))
        If Validate_ProvAppt = False Then
            strSQL = "SELECT START_TIME, END_TIME FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtAppointment.ProviderID & " AND " _
                ...
                & "CONVERT(VARCHAR, START_DATE, 10)  > '" & Format(strStartDate, "mm/dd/yyyy") & "' AND CONVERT(VARCHAR, START_DATE, 10) < '" & Format(strEndDate, "mm/dd/yyyy") & "' And " _
                & "CONVERT(VARCHAR,  END_DATE, 10) < '" & Format(strEndDate, "mm/dd/yyyy") & "' AND ACTIVE = 1  " _
                & "AND CONVERT(VARCHAR,  END_DATE, 10) > '" & Format(strStartDate, "mm/dd/yyyy") & "'  ORDER BY START_TIME DESC"
                 Set rsTerms = cnTerms.Execute(strSQL)
                With rsTerms
                    Clear_Block
                    Do Until .EOF
    ...
    If Not Validate_ProvAppt Then
        ...
        If Not Validate_ProvAppt Then
            ...
            strSQL = "SELECT APPT_TIME, COUNT(APPT_TIME) As BOOKED_APPT, ACTIVE, PROVIDER_ID, APPT_DATE  " _
                ...
                & "Having COUNT(APPT_TIME) > 0 AND CONVERT(VARCHAR, APPT_DATE , 10)  = '" & Format(strData, "hh:mm AM/PM") & "' AND CONVERT(DATETIME, APPT_TIME, 108) " _
...
Dim lngFacID As Long
    ...
    If cnCodes.State = adStateClosed Then cnCodes.open psConnect(1)
    If Trim(vstrType) <> vbNullString Then
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE , PROVIDER_TITLE FROM APPOINTMENT_TYPE WHERE VISIT_TYPE like '" & vstrType & "%'  ORDER BY PROVIDER_TITLE, APPT_CODE"
    Else
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE , PROVIDER_TITLE FROM APPOINTMENT_TYPE  WHERE FACILITY_ID = " & lngFacID & " ORDER BY PROVIDER_TITLE,APPT_CODE"
    End If
    Set rsCodes = cnCodes.Execute(strSQL)
    Do Until rsCodes.EOF
        strProvider = vbNullString
...
Dim lngVendorID As Long
    ...
    If cnReferral.State = adStateClosed Then cnReferral.open psConnect(0)
    strSQL = "SELECT * FROM VENDORS WHERE VENDOR_NAME like '" & vstrData & "%'  ORDER BY VENDOR_NAME"
    Set rsReferral = cnReferral.Execute(strSQL)
    With rsReferral
        Do Until .EOF
            Clear_Vendor
...
Dim Idx As Integer
    ...
    strSQL = "SELECT DISTINCT POS_CODE, POS_NAME FROM PLACE_SERVICE"
...
Dim strNow As String
    ...
    If Trim(udtSchedPatient.IntId) <> vbNullString Then
        ...
        strReason = Trim(cboReason.Text)
        Open_DB psConnect(0)
        strSQL = "SELECT APPT_ID FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND  PROVIDER_ID = " & lngProviderID & " And FACILITY_ID = " & lngFacilityID & " AND " _
                & " CONVERT(VARCHAR, APPT_DATE , 10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND ACTIVE = 1 AND CONVERT(DATETIME, APPT_TIME,108)  = '" & Format(udtAppointment.SchedTime, "hh:mm AM/PM") & "'"
        Set rs = cn.Execute(strSQL)
        With rs
            If Not .EOF Then
        ...
        If lngApptID = 0 And udtSchedPatient.IntId <> vbNullString Then
            strSQL = "Insert into APPOINTMENTS (PATIENT_ID, FACILITY_ID, PROVIDER_ID, PATIENT_TYPE, PURPOSE_VISIT, APPT_DATE, APPT_TIME," _
                & "NOTES, APPT_CONFIRMED, STATUS, REASON, REPEAT_APPOINT, DURATION, ACTIVE,REFERRAL_ID, REFERRAL_REASON, APPT_TYPE, USER_ID ) " _
                & "Values(" & Val(udtSchedPatient.IntId) & ", " & lngFacilityID & "," & lngProviderID & ",'" & strPatientType & "','" & strPurpose & "','" & strDate & "','" _
                & strTime & "','" & strNotes & "','" & strConfirm & "','" & strStatus & "','" & strReason & "','" & strRepeatAppt & "','" & strDuration & "',1," _
                & lngReferral & ",'" & strReferral & "', '" & udtAppointment.SchedType & "','" & PsUserID & "')"
            Set rs = cn.Execute(strSQL)
        ElseIf udtSchedPatient.IntId <> vbNullString Then
            strNow = Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM")
            strSQL = "Update APPOINTMENTS set ACTIVE = 1, PURPOSE_VISIT = '" & strPurpose & "', Duration = '" & strDuration & "'," _
                & "NOTES = '" & strNotes & "', PATIENT_TYPE = '" & strPatientType & "', UPDATE_DATE = '" & strNow & "'," _
                & "APPT_CONFIRMED = '" & strConfirm & "',STATUS = '" & strStatus & "', REASON = '" & strReason & "', REPEAT_APPOINT =  '" & strRepeatAppt & "', " _
                & "REFERRAL_ID = " & lngReferral & ", USER_ID = '" & PsUserID & "', REFERRAL_REASON = '" & strReferral & "', APPT_TYPE = '" & udtAppointment.SchedType & "' WHERE APPT_ID = " & lngApptID
            Set rs = cn.Execute(strSQL)
        End If
        Close_DB psConnect(0)
    End If
...
Dim booMisMatch As Boolean
    ...
    udtAppointment.SchedDate = Format(udtAppointment.SchedDate, "mm/dd/yyyy")
    strSQL = "SELECT  * FROM APPOINTMENTS " _
            & "WHERE CONVERT(VARCHAR, APPT_DATE, 10) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND FACILITY_ID = " & lngFacilityID & " AND " _
            & "PROVIDER_ID = " & lngProviderID & " AND  Patient_id = " & lngPatientID & " AND CONVERT(DATETIME, APPT_TIME,108)  = '" & Format(udtAppointment.SchedTime, "hh:mm AM/PM") & "'"
        udtAppointment.VisitType = vbNullString
        Set rsSched = cnSched.Execute(strSQL)
        With rsSched
            If Not .EOF Then
...
Dim strApptDate As String
   ...
   ' strTime = ccdTime.Value
    ...
    If mbooCancel Then
        ...
        Exit Function
    End If
    strSQL = "Select * from Appointments where appt_date = '" & strApptDate & "' and " _
            & "appt_Time = '" & strTime & "' and provider_id = " & udtAppointment.ProviderID & " AND " _
            & "FACILITY_ID = " & piFacilityID & " AND ACTIVE = 0"
    Open_DB psConnect(0)
    Set rs = cn.Execute(strSQL)
    intCount = 0
    With rs
    ...
    If sValue <> vbNullString And Not mbLookupPatient Then
        ...
        End If
    End If
    strSQL = "Select appt_time from Appointments where " _
            & " appt_date = '" & strApptDate & "' and patient_id = " & Val(udtSchedPatient.IntId) & " And " _
            & "Active = 1 and provider_id = " & lngProviderID & " AND ACTIVE = 0"
    Open_DB psConnect(0)
    Set rs = cn.Execute(strSQL)
    With rs
        If Not .EOF Then
...
Dim Idx As Integer
    ...
    If cnReferral.State = adStateClosed Then cnReferral.open psConnect(0)
    Screen.MousePointer = vbHourglass
    strSQL = "SELECT  REFERRAL_ID, REFERRAL_REASON FROM SUPERBILL  WHERE  PATIENT_ID = " & Val(udtSchedPatient.IntId) & "  ORDER BY INSERT_DATE DESC"
    Set rsReferral = cnReferral.Execute(strSQL)
    With rsReferral
        Do Until .EOF
            If Not IsNull(!Referral_ID) Then
...
Dim rsAppt As New ADODB.Recordset
    ...
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(1)
    strSQL = "SELECT APPT_TIME FROM APPOINTMENT_TYPE WHERE APPT_CODE = '" & vstrReason & "'"
    Set rsAppt = cnAppt.Execute(strSQL)
    If Not rsAppt.EOF Then
        If rsAppt.Fields("APPT_TIME") <> vbNullString Then udtEncounter.VisitTime = rsAppt.Fields("APPT_TIME")
    End If
    If cnAppt.State = adStateOpen Then
        cnAppt.Close
        Set cnAppt = Nothing
