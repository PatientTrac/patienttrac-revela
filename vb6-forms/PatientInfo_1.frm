...
Begin VB.Form PatientInfo 
   ...
   Begin VB.Frame fraPatient 
      ...
      Begin VB.ComboBox cboPatientRace 
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":168C
         Left            =   1965
         List            =   "PatientInfo.frx":168E
         Style           =   2  'Dropdown List
         TabIndex        =   62
         Top             =   4890
         Width           =   2145
      ...
      Begin VB.Frame fraPartName 
         ...
         Begin PT_XP_Button.PT_XP cmdParOk 
            ...
            PictureDisabled =   "PatientInfo.frx":287E
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdPartCancel 
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "PatientInfo.frx":35E2
            ShowFocus       =   -1  'True
         End
      ...
      Begin VB.ComboBox cboLanguage 
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":3934
         Left            =   4275
         List            =   "PatientInfo.frx":3936
         Style           =   2  'Dropdown List
         TabIndex        =   7
      ...
      Begin VB.ComboBox cboPrefContact 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":3938
         Left            =   6540
         List            =   "PatientInfo.frx":3945
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   450
         Width           =   1965
      ...
      Begin VB.ComboBox cboStatus 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":396D
         Left            =   6570
         List            =   "PatientInfo.frx":397A
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   3660
         Width           =   1995
      ...
      Begin VB.ComboBox cboBloodType 
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":399A
         Left            =   1980
         List            =   "PatientInfo.frx":39B6
         Style           =   2  'Dropdown List
         TabIndex        =   1
         Top             =   4500
         Width           =   1305
      ...
      Begin PT_XP_Button.PT_XP cmdNew 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":3F7C
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdUpdate 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":4868
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdCancel 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":4F54
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdClose 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":5CB8
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdSave 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":63A4
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdTakePic 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":6FD0
         ShowFocus       =   -1  'True
      End
...
Dim strSS As String
    ...
    strSQL = "SELECT PATIENT_ID, SOCIAL_SECURITY, BIRTH  FROM PATIENT WHERE LAST_NAME  like '" & strLastName & "' AND FIRST_NAME =  '" & clsPatient.FirstName & "'"
...
Private Function Load_InPatient_Address()
    clsPatient.Address = clsFacility.Address
    clsPatient.Address2 = clsFacility.Address2
    clsPatient.City = clsFacility.City
    clsPatient.State = clsFacility.State
    clsPatient.Zip = clsFacility.Zip
    Exit Function
End Function
...
Error_Update_Archive:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Error_Update_Archive", App.EXEName & "." & Me.Name
    Exit Function
End Function
...
Error_Update_ThirdParty:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Update_ThirdParty", App.EXEName & "." & Me.Name
    Exit Function
    Resume
End Function
...
Dim lngDateDiff As Long
    ...
    Arr = Split(Trim(txtFullName.Text), " ")
...
'          MsgBox "Patient requires a First Name!", vbExclamation, "PatientTrac Patient Information"
'          Validate_Entries = False
'          Exit Function
'    End If
'    If Trim(clsPatient.LastName) = vbNullString Then
'          MsgBox "Patient requires a Last Name!", vbExclamation, "PatientTrac Patient Information"
'          Validate_Entries = False
'          Exit Function
'    End If
    ...
    If IsDate(clsPatient.DOB) Then
        If lngDateDiff = DateDiff("yyyy", clsPatient.DOB, Now) Then
            If lngDateDiff > 150 Then
                MsgBox "Invalid Date of Birth selected!, Patient is calculated at" & " " & CStr(lngDateDiff), vbExclamation, "PatientTrac Patient Information"
                Validate_Entries = False
            End If
        End If
    Else
    ...
    If optFemale.Value = False And optMale.Value = False Then
          ...
          Exit Function
    End If
    If Trim(clsPatient.Address) = vbNullString Then
...
Error_SaveNotes:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, "", "SaveNotes", App.EXEName & "." & Me.Name
    Exit Sub
    Resume
End Sub
...
Dim i%
    ...
    If mFirst Then
        ...
        mbNotSave = False
        cboFacility.Clear
        mstrConnectStringClinical = psConnect(0)
        mstrConnectStringTerms = psConnect(1)
        If piFacilityID = 0 Then
        ...
        If mNewPatient = False Then
            If udtPatientName.IntId <> vbNullString Then piPatientID = Val(udtPatientName.IntId)
            Dump_PatientStrData
            Set_Patient
        Else
            Clear_UdtPatient
...
Dim lngDateDiff As Long
    ...
    If Validate_Entries Then
        ...
        If Not mNewPatient Then
                ...
                Else
                    MsgBox "PatientTrac cannot save data since the Patient's Name, Date of Birth and Social Security Number" _
                        & "matches existing Patient record, either Select Cancel or Enter a new Date of Birth or Social Security Number", vbInformation, "Patient Maintance"
                        mbNotSave = True
                        mbNewPatReg = False
                        txtSS1.Text = vbNullString
                        txtSS2.Text = vbNullString
...
Error_Save_Data:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Save_Data", App.EXEName & "." & Me.Name
    Exit Function
    Resume
End Function
...
Dim i%
    ...
    If Validate_Entries Then
        ...
        If Trim(clsPatient.DOB) <> vbNullString Then clsPatient.DOB = Format(clsPatient.DOB, "mm/dd/yyyy")
...
Error_UpdatePatientInfo:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "UpdatePatientInfo", App.EXEName & "." & Me.Name
    Exit Function
    Resume
End Function
...
Dim lngPrimKey As Long
    ...
    If piPatientID > 0 Then
        ...
        End If
    End If
    udtPatientName.SS = Format(udtPatientName.SS, "000-00-0000")
    If cnPatient.State = adStateOpen Then
         cnPatient.Close
         Set cnPatient = Nothing
         Set rsPatient = Nothing
        ...
        For Each Fld In Flds
            If Not IsNull(Fld.Value) Then
                If Trim(Fld.Value) <> vbNullString Then
                    Select Case UCase(Fld.Name)
                        Case "FIRST_NAME"
                            clsPatient.FirstName = Fix_Name(Fld.Value)
                        Case "MIDDLE_NAME"
                            clsPatient.MiddleName = IsProperCase(Fld.Value)
                        Case "LAST_NAME"
                            clsPatient.LastName = Fix_Name(Fld.Value)
                        ...
                        Case "GENDER"
                            ...
                            End If
                        Case "TITLE"
                            clsPatient.Title = Fix_Title(Fld.Value)
                        ...
                        Case "ADDRESS1"
                            clsPatient.Address = Fix_Name(Fld.Value)
                        Case "ADDRESS2"
                            clsPatient.Address2 = Fix_Name(Fld.Value)
                        Case "CITY"
                            clsPatient.City = Fix_Name(Fld.Value)
                            clsPatient.CityStateZip = clsPatient.City & ", " & clsPatient.State & " " & clsPatient.Zip
                        Case "STATE"
                        ...
                        Case "EMERGENCY_CONTACT"
                            ...
                            clsEmerg.Name = Fix_Name(clsPatient.EmergContact)
...
'----------
    ...
    End If
    clsPatient.SS = Format(clsPatient.SS, "000-00-0000")
...
Error_SetPatient:
    Screen.MousePointer = vbHourglass
    Write_Error Err.Description, Err.Number, strSQL, "Set_Patient", App.EXEName & "." & Me.Name
    Exit Sub
    Resume
End Sub
...
Dim strAddress As String
    If mbooByPass Then mbooByPass = False: Exit Sub
    If Trim(clsPatient.Address) <> vbNullString And clsEDI_Client.Site_ID = "1125" Then
...
Error_Get_RelationshipTerms:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Get_RelationshipTerms", App.EXEName & "." & "ModPatientData"
    Exit Function
    Resume
End Function
...
'            Exit Sub
'        Else
'            mlngRelationPatID = val(strRS(0, 0))
'        End If
'
