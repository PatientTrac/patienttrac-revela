...
Begin VB.Form frmPatientAppointment 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "frmPatientAppointment.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmPatientAppointment.frx":08CA
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "cmdPrevWeek"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "cmdNextWeek"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "cmdCurrentWeek"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdFacility"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "cmdProvider"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "grdData"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "fraFacility"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cctFacilities"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "cctProvider"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "fraProvider"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).ControlCount=   10
      TabCaption(1)   =   "Messages"
      TabPicture(1)   =   "frmPatientAppointment.frx":08E6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "grdMessages"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Schedule Changes"
      TabPicture(2)   =   "frmPatientAppointment.frx":0902
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "grdChanges"
      ...
      Begin VB.Frame fraProvider 
         ...
         Begin PT_XP_Button.PT_XP cmdCloseList 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmPatientAppointment.frx":091E
            AppearanceThemes=   3
            ...
            PictureDisabled =   "frmPatientAppointment.frx":1330
            ShowFocus       =   -1  'True
         End
         Begin FPSpreadADO.fpSpread grdProviders 
            ...
            ShadowDark      =   8388608
            ShadowText      =   8388608
            SpreadDesigner  =   "frmPatientAppointment.frx":1682
            UserResize      =   0
            Appearance      =   2
            TextTipDelay    =   100
            ScrollBarTrack  =   1
      ...
      Begin VB.Frame fraFacility 
         ...
         Begin PT_XP_Button.PT_XP cmdCloseFac 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmPatientAppointment.frx":1D3F
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close"
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmPatientAppointment.frx":2751
            ShowFocus       =   -1  'True
         End
         Begin FPSpreadADO.fpSpread grdFacility 
            ...
            ShadowDark      =   8388608
            ShadowText      =   8388608
            SpreadDesigner  =   "frmPatientAppointment.frx":2AA3
            UserResize      =   0
            Appearance      =   2
            TextTipDelay    =   100
            ScrollBarTrack  =   1
      ...
      Begin FPSpreadADO.fpSpread grdData 
         DragIcon        =   "frmPatientAppointment.frx":3160
         Height          =   6405
         Left            =   240
         TabIndex        =   39
         Top             =   1140
         ...
         ShadowDark      =   8388608
         ShadowText      =   8388608
         SpreadDesigner  =   "frmPatientAppointment.frx":35A2
         UnitType        =   0
         UserResize      =   0
         Appearance      =   2
         TextTip         =   3
      ...
      Begin FPSpreadADO.fpSpread grdMessages 
         ...
         ShadowDark      =   8388608
         ShadowText      =   8388608
         SpreadDesigner  =   "frmPatientAppointment.frx":3CB6
         UnitType        =   0
         UserResize      =   0
         Appearance      =   2
         TextTipDelay    =   60000
      ...
      Begin FPSpreadADO.fpSpread grdChanges 
         ...
         ShadowDark      =   0
         ShadowText      =   0
         SpreadDesigner  =   "frmPatientAppointment.frx":43B8
         UnitType        =   0
         UserResize      =   0
         Appearance      =   1
         TextTipDelay    =   50
      ...
      Begin PT_XP_Button.PT_XP cmdProvider 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":4AB7
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Providers"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":5051
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdFacility 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":53A3
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Facilities"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":593D
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdCurrentWeek 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":5C8F
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":6029
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdNextWeek 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":637B
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Next Week"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":6715
         PictureAlignment=   5
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPrevWeek 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":6A67
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":6E01
         ShowFocus       =   -1  'True
      End
   End
   Begin VB.Frame fraSchLegend 
      ...
      Begin PT_XP_Button.PT_XP cmdCancel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmPatientAppointment.frx":7153
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmPatientAppointment.frx":7B65
         ShowFocus       =   -1  'True
      End
   ...
   Begin RichTextLib.RichTextBox rtfChanges 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"frmPatientAppointment.frx":7EB7
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Times New Roman"
         Size            =   9
         Charset         =   0
   ...
   Begin PT_XP_Button.PT_XP cmdStop 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmPatientAppointment.frx":7F3B
      AppearanceThemes=   3
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmPatientAppointment.frx":84D5
      ShowFocus       =   -1  'True
   End
   ...
   End
End
Attribute VB_Name = "frmPatientAppointment"
...
Private Sub grdAvailAppt_Advance(ByVal AdvanceNext As Boolean)

End Sub

Private Sub grdAvailAppt_CTCreateRendererControl(ByVal Name As String, ByVal Style As Long, ByVal CtrlId As Long, RendererControl As Variant)
