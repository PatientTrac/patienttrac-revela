...
Begin VB.Form frmBlockTime 
   ...
   Begin VB.Frame fraSchedConflicts 
      ...
      Begin PT_XP_Button.PT_XP cmdExit 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmBlockTime.frx":6D1A
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPrintList 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmBlockTime.frx":7606
         ShowFocus       =   -1  'True
      End
   End
   ...
   Begin PT_XP_Button.PT_XP cmdDurationBlock 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmBlockTime.frx":7958
      BackColorDown   =   15133676
      TransparentColor=   14215660
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmBlockTime.frx":7EF2
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cboReasonTerms 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmBlockTime.frx":8244
      AppearanceThemes=   3
      TransparentColor=   14215660
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmBlockTime.frx":87DE
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdClose 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":9542
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdSaveBlock 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":9E2E
      ShowFocus       =   -1  'True
   End
   Begin FPSpreadADO.fpSpread grdBlock 
      ...
      ShadowDark      =   8388608
      ShadowText      =   8388608
      SpreadDesigner  =   "frmBlockTime.frx":A180
      UserResize      =   0
      Appearance      =   1
      ClipboardOptions=   0
      CellNoteIndicator=   3
   ...
   Begin PT_XP_Button.PT_XP cmdRemoveRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":AA05
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdGridRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":B2F1
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdPrint 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":BBDD
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdDate 
      Height          =   345
      Left            =   11460
      TabIndex        =   41
      Top             =   60
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":C4C9
      ShowFocus       =   -1  'True
   End
...
Dim strSuffix As String
    ...
    strSQL = "Select * FROM PROVIDERS WHERE PROVIDER_ID = " & mlngLogonUser
...
'    cboDuration.AddItem "Date Range"
    ...
    strSQL = "SELECT * FROM ATTR_VALID_VALUE WHERE VALID_VALUE_SUBDOM = 'sd_Appointment_BlockDuration' ORDER BY  VALID_VALUE_SEQ_NBR"
    ...
    Select Case UCase(frmPatientAppointment.mInterval)
       ...
       Case "EVERY 10 MIN"
        ...
        cboRepTimeFrom.AddItem "12:00 PM": cboRepTimeFrom.AddItem "12:10 PM": cboRepTimeFrom.AddItem "12:20 PM": cboRepTimeFrom.AddItem "12:30 AM": cboRepTimeFrom.AddItem "12:40 AM": cboRepTimeFrom.AddItem "12:50 AM"
        ...
        cboRepTimeFrom.AddItem "02:00 PM": cboRepTimeFrom.AddItem "02:10 PM": cboRepTimeFrom.AddItem "02:20 PM": cboRepTimeFrom.AddItem "02:30 PM": cboRepTimeFrom.AddItem "02:40 AM": cboRepTimeFrom.AddItem "02:50 PM"
        ...
        cboRepTimeTo.AddItem "12:00 PM": cboRepTimeTo.AddItem "12:10 PM": cboRepTimeTo.AddItem "12:20 PM": cboRepTimeTo.AddItem "12:30 AM": cboRepTimeTo.AddItem "12:40 AM": cboRepTimeTo.AddItem "12:50 AM"
...
Dim strName As String
    ...
    strSQL = "SELECT * FROM FACILITIES  WHERE ACTIVE = 1 ORDER BY FACILITY_NAME"
...
Dim strCompareFac As String
    ...
    Do Until rsFac.EOF
        If Not IsNull(rsFac.Fields("FACILITY_NAME")) Then
            ...
            If rsFac.Fields("FACILITY_NAME") <> vbNullString Then
                If IsProperCase(strCompareFac) = IsProperCase(Trim(strFacility)) Then
...
Dim lngFacID As Long
    ...
    strSQL = "SELECT b.*, a.PROVIDER_ID from APPOINTMENT_PROVIDERS a, PROVIDERS b " _
        & "where a.FACILITY_ID = " & udtFacility.FacID & " and b.PROVIDER_ID = a.PROVIDER_ID and b.ACTIVE = 1"
...
Dim strFac As String
    ...
    Clear_Facility
    If cnFac.State = adStateClosed Then cnFac.open psConnect(0)
    strSQL = "Select * FROM FACILITIES WHERE FACILITY_ID = " & lngFacID
    Set rsFac = cnFac.Execute(strSQL)
...
'                strSelect = Trim(.TypeComboBoxString)
'                strSelect = Replace(strSelect, ".", "")
'                vstrData = Replace(vstrData, ".", "")
'                If Trim(vstrData) = Trim(strSelect) Then
...
Dim lngPrimKey As Long
    ...
    strSQL = "SELECT * FROM APPOINTMENTS_BLOCKS  WHERE PROVIDER_ID = " & vlngProvider & " AND ACTIVE = 1 ORDER BY " _
        & "START_DATE DESC"
...
Dim lngPrimKey As Long
    ...
    Screen.MousePointer = vbHourglass
    udtBlock.ProviderID = vlngProvider
    grdBlock.ClearRange 1, 1, grdBlock.MaxCols, grdBlock.MaxRows, False
    grdBlock.MaxRows = 0
    ...
    If cnBlock.State = adStateClosed Then cnBlock.open psConnect(1)
    strSQL = "select * FROM APPOINTMENTS_BLOCKS  WHERE ACTIVE = 1 AND PROVIDER_ID = " & udtBlock.ProviderID & " AND " _
        & "convert(DATETIME, START_DATE, 101)  BETWEEN '" & Format(udtTime.StartDate, "mm/dd/yyyy") & "' AND '" & Format(udtTime.EndDate, "mm/dd/yyyy") & "' OR " _
        & "ACTIVE = 1 AND PROVIDER_ID = " & udtBlock.ProviderID & " AND convert(DATETIME, END_DATE, 101) BETWEEN '" & Format(udtTime.StartDate, "mm/dd/yyyy") & "' AND '" & Format(udtTime.EndDate, "mm/dd/yyyy") & "' ORDER BY START_DATE DESC"
    Set rsBlock = cnBlock.Execute(strSQL)
    Do Until rsBlock.EOF
        Clear_BlockTerm
        Set Flds = rsBlock.Fields
        ...
        If Not Validate_Save Then
            ...
            Else
                strSQL = "UPDATE  APPOINTMENTS_BLOCKS SET START_TIME = '" & Trim(udtBlock.StartTime) & "', DAYWEEK = '" & Trim(udtBlock.DayWeek) & "'," _
                    & "END_TIME = '" & Trim(udtBlock.EndTime) & "', END_DATE = '" & Trim(udtBlock.EndDate) & "'," _
...
Dim lngPrimKey As Long
   ...
   ' strEnd = DateAdd("n", 1, udtBlock.EndTime)
    If cnTerms.State = adStateClosed Then cnTerms.open psConnect(1)
     strSQL = "SELECT BLOCK_ID, START_TIME, END_TIME, START_DATE, END_DATE FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtBlock.ProviderID & " AND " _
        ...
        & "DURATION = '1 Day' AND  CONVERT(DATETIME, START_DATE, 101)  > '" & Format(strStartDate, "mm/dd/yyyy") & "' AND CONVERT(DATETIME, START_DATE, 101) < '" & Format(strEndDate, "mm/dd/yyyy") & "' And " _
  ...
  '  strEnd = DateAdd("n", 1, udtBlock.EndTime)
    If Validate_BlockTime = False Then
        strSQL = "SELECT BLOCK_ID, START_TIME, END_TIME, START_DATE, END_DATE  FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtBlock.ProviderID & " AND DAYWEEK = '' AND " _
            & "FACILITY_ID = " & udtBlock.FacilityID & " AND DURATION = 'Permanent' AND ACTIVE = 1 AND " _
...
'                                End If
    ...
    '                                If Format(udtBlock.StartTime, "hh:mm AM/PM") <= Format(strEnd, "hh:mm AM/PM") Then
        ...
        End If
        If Validate_BlockTime = False Then
            strSQL = "SELECT * FROM APPOINTMENTS_BLOCKS WHERE PROVIDER_ID = " & udtBlock.ProviderID & " AND " _
                & "FACILITY_ID = " & udtBlock.FacilityID & " And DateDiff(Day, '" & strRange & "', START_DATE) > 0 AND " _
                & "DURATION <> 'Permanent' AND DURATION <> '1 Day' AND ACTIVE = 1"
                Set rsTerms = cnTerms.Execute(strSQL)
                Do Until rsTerms.EOF
                    Clear_Block
                    Set Flds = rsTerms.Fields
...
Private Sub cboDuration_Change()
    ...
    If cboDuration.Text <> "1 Day" Then
       If cboWeek.Enabled = False Then cboWeek.Enabled = True
    End If
End Sub
...
Dim iAnswer As Integer
    ...
    'If Trim(udtBlock.EndDate) = vbNullString Then
        udtBlock.EndDate = Format(ccdEndDate.Value, "mm/dd/yyyy")
   ' End If
    udtBlock.Duration = cboDuration.Text
    ...
    If udtBlock.StartDate <> vbNullString And udtBlock.EndDate <> vbNullString Then
       If Validate_BlockTime Then
            Exit Sub
'            iAnswer = MsgBox("There are existing block times in this time range, do you want to continue?", vbYesNo, "PatientTrac Block Mode")
                ...
                Case "START_DATE", "END_DATE", "DURATION", "DAYWEEK"
                    ...
                    If Trim(cboDuration.Text) <> vbNullString Then
                        ...
                        If UBound(Arr) > 0 Then
                          lngCol = Arr(0)
                        End If
                        Format_CellTypeStatic grdBlock, mlngGridRow, lngCol, "1", Trim(cboDuration.Text), "TypeHAlignCenter", "DURATION", "TypeHAlignCenter", 0, ""
                        grdBlock.SetCellBorder mlngGridCol, mlngGridRow, mlngGridCol, mlngGridRow, CellBorderIndexOutline, GridBlue, CellBorderStyleSolid
                    End If
...
Dim lngApptID As Long
    ...
    End If
    If Trim(udtBlock.EndDate) <> vbNullString Then
            strEndDate = Format(udtBlock.EndDate, "mm/dd/yyyy 00:00:00 AM/PM")
    ...
    If DateDiff("d", udtBlock.StartDate, udtBlock.EndDate) > 0 Then
        strSQL = "SELECT APPOINTMENTS.*, PATIENT.LAST_NAME FROM APPOINTMENTS INNER JOIN PATIENT ON APPOINTMENTS.PATIENT_ID = PATIENT.PATIENT_ID " _
            & "WHERE CONVERT(VARCHAR, APPOINTMENTS.APPT_DATE, 10) BETWEEN '" & Format(strStartDate, "mm/dd/yyyy") & "' AND '" & Format(strEndDate, "mm/dd/yyyy") & "' AND " _
            & "APPOINTMENTS.PROVIDER_ID = " & udtBlock.ProviderID & " AND APPOINTMENTS.FACILITY_ID = " & udtBlock.FacilityID & " AND " _
            & "APPOINTMENTS.ACTIVE = 1 AND CONVERT(DATETIME, APPOINTMENTS.APPT_TIME, 108) BETWEEN '" & Format(strStart, "hh:mm AM/PM") & "' AND '" & Format(strEndTime, "hh:mm AM/PM") & "' ORDER BY " _
            & "APPOINTMENTS.PATIENT_ID, PATIENT.LAST_NAME, APPOINTMENTS.APPT_DATE DESC "
        Set rsTerms = cnTerms.Execute(strSQL)
    Else
        strSQL = "SELECT APPOINTMENTS.*, PATIENT.LAST_NAME  FROM APPOINTMENTS INNER JOIN PATIENT ON APPOINTMENTS.PATIENT_ID = PATIENT.PATIENT_ID " _
            & "WHERE CONVERT(VARCHAR, APPOINTMENTS.APPT_DATE, 10) = '" & Format(strStartDate, "mm/dd/yyyy") & "' AND " _
            & "APPOINTMENTS.PROVIDER_ID = " & udtBlock.ProviderID & " AND APPOINTMENTS.FACILITY_ID = " & udtBlock.FacilityID & " AND " _
            & "APPOINTMENTS.ACTIVE = 1 AND CONVERT(DATETIME, APPT_TIME, 108) BETWEEN '" & Format(strStart, "hh:mm AM/PM") & "' AND '" & Format(strEndTime, "hh:mm AM/PM") & "' ORDER BY " _
            & "APPOINTMENTS.PATIENT_ID, PATIENT.LAST_NAME "
        Set rsTerms = cnTerms.Execute(strSQL)
    End If
    Set rsTerms = cnTerms.Execute(strSQL)
    Do Until rsTerms.EOF
    ...
    Set Flds = rsTerms.Fields
        ...
        If Not Valid_RepeatAppt(lngApptID) Then
            If lngPatID <> Val(udtSchedPatient.IntId) Then
                ...
                ElseIf udtAppointment.SchedType = "Business" Then
                   Get_SchedVendor Val(udtSchedPatient.IntId)
                End If
    ...
    With rsMedProv
        Do Until .EOF
            ...
            If clsProvider.Name <> vbNullString Then
             ...
             '   cboStaff.AddItem clsProvider.Name
                cboProviders.ItemData(cboProviders.NewIndex) = lngProvID
              '  cboStaff.ItemData(cboStaff.NewIndex) = lngProvID
            End If
        Loop
    End With
    If cnMedProv.State = adStateOpen Then
        ...
        Set Flds = Nothing
    End If
'    For Idx = 0 To cboStaff.ListCount - 1
'        If cboStaff.ItemData(Idx) = mlngLogonUser Then
'            cboStaff.Text = cboStaff.List(Idx)
'            Exit For
'        End If
'    Next Idx
    Screen.MousePointer = vbDefault
...
Public Sub SetEndDate(ipDuration As String)
    Select Case IsProperCase(ipDuration)
       Case "1 Week"
            ccdEndDate.Value = ccdStartDate.Value + 6
            ccdEndDate.Enabled = False
       Case "2 Weeks", "2 Week"
            ccdEndDate.Value = ccdStartDate.Value + 13
            ccdEndDate.Enabled = False
       Case "3 Week", "3 Weeks"
            ccdEndDate.Value = ccdStartDate.Value + 20
            ccdEndDate.Enabled = False
       Case "1 Month", "1 Months"
            ccdEndDate.Value = ccdStartDate.Value + 29
            ccdEndDate.Enabled = False
       Case "2 Months"
            ccdEndDate.Value = ccdStartDate.Value + 59
            ccdEndDate.Enabled = False
       Case "3 Months"
            ccdEndDate.Value = ccdStartDate.Value + 89
            ccdEndDate.Enabled = False
       Case "6 Months"
            ccdEndDate.Value = ccdStartDate.Value + 179
            ccdEndDate.Enabled = False
       Case "1 Year"
            ccdEndDate.Value = ccdStartDate.Value + 364
            ccdEndDate.Enabled = False
       Case "1 Day"
            cboWeek.ListIndex = -1
            cboWeek.Enabled = False
            ccdEndDate.Value = ccdStartDate.Value
            ccdEndDate.Enabled = False
       Case Else
