...
Begin VB.Form frmSchedPatient 
   ...
   Begin VB.Frame fraPlan 
      ...
      Begin FPSpreadADO.fpSpread grdPlan 
         ...
         ShadowDark      =   8388608
         ShadowText      =   4194304
         SpreadDesigner  =   "frmSchedPatient.frx":058A
         UnitType        =   0
         UserResize      =   0
         Appearance      =   1
         TextTipDelay    =   50
      ...
      Begin PT_XP_Button.PT_XP cmdPlan 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":0AA2
         AppearanceThemes=   3
         ...
         PictureDisabled =   "frmSchedPatient.frx":14B4
         ShowFocus       =   -1  'True
      End
   End
   Begin VB.Frame fraChange 
      ...
      Begin LpADOLib.fpComboAdo fpTerm 
         ...
         EditAlignV      =   0
         AllowAnimate    =   -1  'True
         ColDesigner     =   "frmSchedPatient.frx":1806
      End
      Begin PT_XP_Button.PT_XP cmdRemoveRow 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":1AC9
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":2063
         ShowFocus       =   -1  'True
      End
      Begin FPSpreadADO.fpSpread grdAppointChange 
         ...
         ShadowDark      =   8388608
         ShadowText      =   0
         SpreadDesigner  =   "frmSchedPatient.frx":23B5
         UserResize      =   0
         Appearance      =   1
         ClipboardOptions=   0
         CellNoteIndicator=   3
      ...
      Begin PT_XP_Button.PT_XP cmdUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":2892
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":2E2C
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdFrameClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":317E
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":3B90
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":3EE2
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Print"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":447C
         ShowFocus       =   -1  'True
      End
   ...
   Begin VB.ComboBox cboApptType 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmSchedPatient.frx":47CE
      Left            =   1980
      List            =   "frmSchedPatient.frx":47E4
      Style           =   2  'Dropdown List
      TabIndex        =   66
      Top             =   345
      Width           =   2970
   ...
   Begin PT_XP_Button.PT_XP cmdEditPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":481E
      AppearanceThemes=   3
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":4DB8
      ShowFocus       =   -1  'True
   End
   ...
   Begin PT_XP_Button.PT_XP cmdTakePic 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":510A
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmSchedPatient.frx":59E4
      ShowFocus       =   -1  'True
   End
   ...
   Begin VB.ListBox lstListBox 
      ...
      EndProperty
      Height          =   540
      ItemData        =   "frmSchedPatient.frx":6636
      Left            =   60
      List            =   "frmSchedPatient.frx":6638
      Sorted          =   -1  'True
      Style           =   1  'Checkbox
      TabIndex        =   1
      Top             =   1365
   ...
   Begin PT_XP_Button.PT_XP cmdClose 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":663A
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "Close"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":704C
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdApply 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":739E
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "&Apply"
      DepthEvent      =   1
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":7738
      ShowFocus       =   -1  'True
   End
   Begin VB.Frame fraInfo 
      ...
      Begin VB.Frame fraPsycho 
         ...
         Begin FPSpreadADO.fpSpread grdPsychotherapy 
            ...
            ShadowDark      =   8388608
            ShadowText      =   8388608
            SpreadDesigner  =   "frmSchedPatient.frx":7A8A
            UserResize      =   0
            Appearance      =   2
            ClipboardOptions=   0
            AppearanceStyle =   0
         ...
         Begin PT_XP_Button.PT_XP cmdPsyAdd 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":7F4D
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Select"
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":82E7
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdPsyClose 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":8639
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close"
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":904B
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdRemAddOn 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":939D
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Remove"
            DefaultThemes   =   2
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":9937
            ShowFocus       =   -1  'True
         End
      End
      ...
      Begin VB.Frame fraRefer 
         ...
         Begin PT_XP_Button.PT_XP cmdRefClose 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":9C89
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close "
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":A69B
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdRefTerms 
            ...
            EndProperty
            MaskColor       =   128
            Picture         =   "frmSchedPatient.frx":A9ED
            AppearanceThemes=   3
            BorderWidth     =   2
            TransparentColor=   14737632
            Caption         =   ".."
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":AF87
            ShowFocus       =   -1  'True
         End
      ...
      Begin VB.ComboBox cboReferBy 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":B2D9
         Left            =   8925
         List            =   "frmSchedPatient.frx":B2DB
         Style           =   2  'Dropdown List
         TabIndex        =   59
         Top             =   3510
         Width           =   2865
      ...
      Begin VB.ComboBox cboSerPlace 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":B2DD
         Left            =   2595
         List            =   "frmSchedPatient.frx":B2DF
         Style           =   2  'Dropdown List
         TabIndex        =   46
      ...
      Begin PT_XP_Button.PT_XP cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":B2E1
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close Me"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":BCF3
         PictureAlignment=   6
         ShowFocus       =   -1  'True
      End
      ...
      Begin VB.ComboBox cboFacility 
         ...
         ForeColor       =   &H00800000&
         Height          =   300
         ItemData        =   "frmSchedPatient.frx":C045
         Left            =   2010
         List            =   "frmSchedPatient.frx":C047
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2820
         Width           =   4335
      ...
      Begin VB.ComboBox cboStatus 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":C049
         Left            =   9420
         List            =   "frmSchedPatient.frx":C04B
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1950
         Width           =   3285
      ...
      Begin PT_XP_Button.PT_XP cmdStatus 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":C04D
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":C5E7
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":C939
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":CED3
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRefReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":D225
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":D7BF
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdChange 
         ...
         EndProperty
         MaskColor       =   128
         Picture         =   "frmSchedPatient.frx":DB11
         AppearanceThemes=   3
         BorderWidth     =   2
         TransparentColor=   14737632
         Caption         =   ""
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":E0AB
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdChangeUser 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":E3FD
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":E997
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRepeat 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":ECE9
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":F283
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdShowAll 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":F5D5
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":FB6F
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdAcct 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":FEC1
         AppearanceThemes=   3
         BorderDrawEvent =   1
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":1045B
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPhyPlan 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":107AD
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":10D47
         ShowFocus       =   -1  'True
      End
      Begin FPSpreadADO.fpSpread grdProcedure 
         ...
         ShadowDark      =   8388608
         ShadowText      =   8388608
         SpreadDesigner  =   "frmSchedPatient.frx":11099
         UserResize      =   0
         Appearance      =   2
         TextTip         =   4
         TextTipDelay    =   100
   ...
   Begin PT_XP_Button.PT_XP cmdNewPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":1156F
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "New Patient"
      CaptionAlignment=   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":11B09
      ShowFocus       =   -1  'True
   End
    ...
    If udtSchedPatient.IntId <> vbNullString Then
        If Val(clsInsBillData.TreatNo) > 0 Then
            If Not TextFound(clsInsBillData.PreAuthNo, Trim(mstrAuthString), Len(clsInsBillData.PreAuthNo), True) Then
                ...
                End If
                If Len(clsInsBillData.TreatRemain) > 2 Then
                    mstrAuthString = "TREATMENT NUMBER: " & " " & Trim(clsInsBillData.TreatRemain)
                End If
                If Len(clsInsBillData.TreatApproved) > 2 Then
                    mstrAuthString = "TREATMENT APPROVED: " & " " & Trim(clsInsBillData.TreatApproved)
                End If
                If Len(clsInsBillData.TreatApproved) > 5 Then
                    mstrAuthString = "CONTACT: " & " " & Trim(clsInsBillData.AuthContact)
                End If
            End If
        End If
    End If
...
Dim strStatus As String
    ...
    strSQL = "Get_PT_Appt_History_Grid_PT_Prov_Date " & Val(udtSchedPatient.IntId) & ", " & lngProviderID & ", '" & Format(ccdRevisedDate.Value, "mm/dd/yyyy") & "'"
...
Dim Arr
    ...
    If clsEDI_Client.Site_ID = "1999" Then
        If vstrType <> vbNullString Then
            strSQL = "Search_Patient_EMR_ID_Join '" & vstrData & "%', " & clsFacility.FacID
        Else
            ...
            End If
            If Trim(strFirst) <> vbNullString Then
                 strSQL = "Search_Patient_FirstName_Last_Name_Join '" & strSearch & "%', '%" & strFirst & "%', " & clsFacility.FacID
            Else
                strSQL = "Search_Patient_Row_Count_Last_Name_Join 25, '" & strSearch & "%', " & clsFacility.FacID
            End If
        End If
    Else
        If vstrType <> vbNullString Then
...
Dim varCellValue
    ...
    ElseIf udtAppointment.SchedType = "Vendor" Or _
        udtAppointment.SchedType = "Business" Then
       cboApptType.ListIndex = 2
    ElseIf udtAppointment.SchedType = "Legal" Or _
        udtAppointment.SchedType = "Attorney" Then
...
Dim lngApptID As Long
    ...
    If Trim(cboStatus.Text) = vbNullString Or (Trim(IsProperCase(cboStatus)) <> "Cancelled" And Trim(cboStatus.Text) <> "Late Cancellation") Then Exit Function
...
Dim lngRow As Long
    ...
    If Trim(udtSchedPatient.IntId) <> vbNullString Then
        Select Case IsProperCase(udtAppointment.SchedType)
            ...
            Case "Legal", "Attorney"
                Get_Schedule_Attorney lngPatientID
            Case "Physician"
    ...
    If Trim(udtSchedPatient.ApptComment) <> vbNullString Then
        If txtComments.Text = vbNullString Then
            txtComments.Text = Trim(udtSchedPatient.ApptComment)
        ElseIf Not TextFound(Trim(udtSchedPatient.ApptComment), txtComments.Text, Len(Trim(udtSchedPatient.ApptComment)), True) Then
            txtComments.Text = txtComments.Text & vbNewLine & Trim(udtSchedPatient.ApptComment)
        End If
    End If
...
Dim lngRow As Long
    ...
    strSQL = "Get_Facility_Class_Facility_ID " & vlngFacility_ID
        ...
        With rsSched
            If Not .EOF Then
                If Not IsNull((!FACILITY_CLASS)) Then strClass = (!FACILITY_CLASS)
            End If
        End With
...
Dim Arr
    ...
    If clsEDI_Client.Site_ID = "9702" Then
        ...
        End If
    Else
        'If clsEDI_Client.Site_ID = "3359" Then
        Clear_Surg_Facility
        Read_Patient_Status Val(udtSchedPatient.IntId)
        Get_Facilities Val(clsFacStatus.FacilityID)
        cctFacility.Text = clsFacility.Name
        ...
        cctFacility.Visible = True
        lblFac.Visible = True
        If cctFacility.Text = vbNullString Then
            cctFacility.Text = cboFacility.Text
        End If
        cctFacility.BackColor = grdCurItem
    End If
    udtFacility.FacID = lngFacilityID
    Exit Sub
...
Dim strList As String
    ...
    If cnCodes.State = adStateClosed Then cnCodes.open psConnect(1)
    If Trim(vstrType) <> vbNullString Then
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE, PROVIDER_TITLE, CPT_CODE " _
            & "FROM APPOINTMENT_TYPE WHERE VISIT_TYPE like '" & vstrType & "%' ORDER BY  APPT_CODE, VISIT_TYPE"
    Else
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE, PROVIDER_TITLE " _
            & "FROM APPOINTMENT_TYPE WHERE " _
            & "FACILITY_ID = @FACILITY_ID  ORDER BY  APPT_CODE, VISIT_TYPE"
    End If
    Set rsCodes = cnCodes.Execute(strSQL)
    With rsCodes
        Do Until .EOF
...
Private Sub ccdTime_KeyDown(KeyCode As Integer, Shift As Integer)
   ' Debug.Print
...
Dim bExit As Boolean
    ...
    Screen.MousePointer = vbHourglass
    strData = Get_Provider_Type(Replace(clsProvider.Title, ".", ""))
    If strData <> vbNullString Then
       Select Case UCase(Replace(strData, ".", ""))
            Case "MD", "DO", "ARNP", "CRNP", "PA", "CNS"
                bFound = True
                If cnCodes.State = adStateClosed Then cnCodes.open psConnect(1)
...
Dim strVisitCode As String
    ...
    If strCode <> vbNullString Then
        ...
        With grdProcedure
            ...
            Next lngTestRow
        End With
        If lngTestRow > 0 Then
            Format_CellTypeEdit grdProcedure, lngTestRow, 3, "1", strDesc, "TypeHAlignCenter", "ADD_DESC"
            Format_CellTypeEdit grdProcedure, lngTestRow, 4, "1", strCode, "TypeHAlignCenter", "ADD_CPT_CODE"
            Arr = Split(strDesc, " ")
            If UBound(Arr) > 0 Then
                For Idx = LBound(Arr) To UBound(Arr)
                ...
                Else
                    ...
                    If Left(Trim(strTime), 2) > Left(Trim(cboDuration.Text), 2) Then
                        For Idx = 0 To cboDuration.listcount - 1
                            If cboDuration.List(Idx) = Trim(strTime) Then
                                cboDuration.Text = cboDuration.List(Idx)
                                Exit For
...
Dim Idx%
    ...
    If Trim(udtSchedPatient.IntId) <> vbNullString Then
        ...
        If cnApptGrid.State = adStateClosed Then cnApptGrid.open psConnect(0)
        If lngApptID > 0 Then
             strSQL = "UPDATE APPOINTMENTS SET ADD_PROC_CODE = '', ADD_PROC_DESC = '' AND " _
                & "UPDATE_DATE = '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "', USER_ID = '" & PsUserID & "' WHERE APPT_ID = " & lngApptID
            Set rsApptGrid = cnApptGrid.Execute(strSQL)
        End If
...
Dim strCode As String
    ...
    With grdProcedure
        If Col = 3 Then
            ...
            Else
                MsgBox "Please select the visit cpt code first!", vbInformation, "PatientTrac Scheduling"
            End If
        Else
            ...
            End If
            udtAppointment.VisitType = udtEncounter.Appt_Type
            Update_Facility_Class udtAppointment.FacilityID, Row
        End If
    End With
...
Dim strCode As String
    ...
    If Row = 0 Then Exit Sub
    Screen.MousePointer = vbHourglass
    Select Case UCase(Replace(clsProvider.Title, ".", ""))
         Case "MD", "DO", "ARNP", "CRNP", "PA", "CNS"
             bFound = True
     End Select
...
Dim Arr
    ...
    If udtSchedPatient.Current_Location = vbNullString Then
        ...
        Else
            udtSchedPatient.Current_Location = "IVF"
        End If
    End If
    If udtSchedPatient.Current_Location = vbNullString Then
        MsgBox "Please select facility type for this visit!", vbInformation, "PatientTrac Scheduling Management"
        Screen.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    If Not Is_NewAppt Then
        If Validate_ProvAppt(ccdTime.Value, cboDuration.Text) Then
            mstrValidAppoint = vbNullString: mbooAlreadyBook = False: mbooCancel = False
            Screen.MousePointer = vbDefault
            Exit Sub
        End If
...
Dim strCurrentDate As String
    Clear_Auth
    If Not IsNull(ccdTime.Value) Then
        udtAppointment.SchedTime = ccdTime.Value
        If IsNull(txtDate.Value) Then
...
Dim strApptTime As String
    ...
    If Trim(udtSchedPatient.IntId) <> vbNullString Then
        ...
        strSQL = "SELECT APPT_ID, APPT_TIME FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
            & "PROVIDER_ID = " & lngProviderID & " AND FACILITY_ID = " & lngFacilityID & " AND " _
            & "CONVERT(VARCHAR(10), APPT_DATE, 101) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND APPT_TYPE = '" & udtAppointment.SchedType & "'"
        Set rsApptGrid = cnApptGrid.Execute(strSQL)
        With rsApptGrid
            Do Until .EOF
                strApptTime = vbNullString
                lngApptID = 0
                If Not IsNull(!APPT_ID) Then
                    lngApptID = (!APPT_ID)
                End If
                If Not IsNull(!Appt_Time) Then
                    strApptTime = (!Appt_Time)
                End If
                .MoveNext
                If strApptTime <> vbNullString Then
                    If Format(strApptTime, "hh:mm AM/PM") = Format(udtAppointment.SchedTime, "hh:mm AM/PM") Then
                        Exit Do
                    End If
                End If
            Loop
        ...
        If lngApptID = 0 And udtSchedPatient.IntId <> vbNullString Then
            strSQL = "Write_Appointment " & Val(udtSchedPatient.IntId) & ", " & lngFacilityID & "," & lngProviderID & ",'" & strPatientType & "','" & strPurpose & "','" & strDate & "','" _
                & strTime & "','" & strNotes & "','" & strConfirm & "','" & strStatus & "','" & strReason & "','" & strRepeatAppt & "','" & strDuration & "',1," _
                & lngReferral & ",'" & strReferral & "', '" & udtAppointment.SchedType & "','" & udtSchedPatient.Current_Location & "','" & PsUserID & "' "
            Set rsApptGrid = cnApptGrid.Execute(strSQL)
             strSQL = "SELECT APPT_ID FROM APPOINTMENTS WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
                & "PROVIDER_ID = " & lngProviderID & " AND FACILITY_ID = " & lngFacilityID & " AND " _
                & "CONVERT(VARCHAR(10), APPT_DATE, 101) = '" & Format(udtAppointment.SchedDate, "mm/dd/yyyy") & "' AND " _
        ...
        ElseIf udtSchedPatient.IntId <> vbNullString Then
            strNow = Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM")
            strSQL = "Update_Appointments_Schedule '" & strPurpose & "','" & strDuration & "', '" _
                & strNotes & "','" & strTime & "','" & strPatientType & "','" & strNow & "','" _
                & strConfirm & "','" & strStatus & "','" & strReason & "','" & strRepeatAppt & "'," _
                & lngReferral & ",'" & strReferral & "','" & udtAppointment.SchedType & "','" & PsUserID & "','" & udtSchedPatient.Current_Location & "'," & lngApptID
            Set rsApptGrid = cnApptGrid.Execute(strSQL)
        End If
    End If
    If Trim(cboStatus.Text) = vbNullString Then udtAppointment.Status = "New Appointment"
    If lngApptID > 0 Then
         strSQL = "UPDATE APPOINTMENTS SET VISIT_CODE = '" & lblCode.Caption & "'," _
            & "ADD_PROC_CODE = '" & strAdd_Proc_Code & "', ADD_PROC_DESC = '" & strAdd_Proc & "', ACTIVE = 1 WHERE APPT_ID = " & lngApptID
        Set rsApptGrid = cnApptGrid.Execute(strSQL)
    End If
    If cnApptGrid.State = adStateOpen Then
        cnApptGrid.Close
...
Dim varCellValue
    ...
    If cnSched.State = adStateClosed Then cnSched.open psConnect(0)
    udtAppointment.SchedDate = Format(udtAppointment.SchedDate, "mm/dd/yyyy")
    strSQL = "Get_PT_Appointment " & lngPatientID & ", " & lngProviderID & ", " & lngFacilityID & ", '" & udtAppointment.SchedDate & "','" & Format(udtAppointment.SchedTime, "hh:mm AM/PM") & "'"
        udtAppointment.VisitType = vbNullString
        Set rsSched = cnSched.Execute(strSQL)
        With rsSched
            If Not .EOF Then
                            ...
                            Else
                                ...
                                For i = 0 To cboPatientType.listcount - 1
                                    If cboPatientType.List(i) = IsProperCase(udtSchedPatient.PatientType) Then
                                        mbooByPass = True
                                        cboPatientType.Text = cboPatientType.List(i)
                                        If grdProcedure.MaxRows = 0 Then Load_Visit cboPatientType.Text
                                        mbooByPass = False
                                        Exit For
                                    End If
                                Next i
                                ...
                                With grdProcedure
                                    ...
                                    If Trim(varCellValue) <> vbNullString Then
                                        If UCase(varCellValue) = UCase(udtAppointment.VisitType) Then
                                            ...
                                            .BlockMode = False
                                            If udtAppointment.VisitType <> vbNullString Then
                                                Update_Facility_Class lngFacilityID, lngRow
                                            End If
                                            .TopRow = lngRow
                                            lblCPT.Visible = True
                                            lblCode.Visible = True
...
Dim Idx%
    ...
    ElseIf udtAppointment.SchedType = "Vendor" Then
       cboApptType.ListIndex = 2
    ElseIf udtAppointment.SchedType = "Legal" Then
       cboApptType.ListIndex = 3
    End If
    lblCode.Caption = vbNullString
    lblCode.Visible = False
    ...
    If mbLookupPatient And Val(udtSchedPatient.IntId) <> 0 Then
       ...
       If Trim(cboSerPlace.Text) <> vbNullString And grdProcedure.MaxRows < 1 Then Load_Visit
       If udtAppointment.SchedType = "Patient" Then
          lblID2.Caption = udtSchedPatient.IntId
...
Dim i%
    ...
    End If
    If cnAppt.State = adStateClosed Then cnAppt.open psConnect(0)
    strSQL = "Validate_Appts_Provider " & udtAppointment.ProviderID & ", " & lngFacility & ", '" & Format(strApptDate, "mm/dd/yyyy") & "', '" & Format(strTime, "hh:mm AM/PM") & "'"
...
'            & "FACILITY_ID = " & piFacilityID & " AND ACTIVE = 0"
    ...
    If sValue <> vbNullString And Not mbLookupPatient Then
        ...
        End If
    End If
    strSQL = "Get_Patient_Appointment_Date " & Val(udtSchedPatient.IntId) & ", " & lngProviderID & ", " & lngFacility & ",'" & strApptDate & "'"
    Set rsAppt = cnAppt.Execute(strSQL)
    With rs
        If Not .EOF Then
            If Not IsNull(!Appt_Time) Then
...
Dim lngDuration As Double
    ...
    If Not IsNull(ccdTime.Value) Then strTime = ccdTime.Value
    lngDuration = Replace(cboDuration.Text, "minutes", "")
    strRange = DateAdd("d", -7, udtAppointment.SchedDate)
    If Trim(strTime) = vbNullString Then
        Screen.MousePointer = vbDefault
        Exit Function
    ...
    strSQL = "Read_BlockTime_ProviderID_Date " & udtAppointment.ProviderID & ",'" & strData & "', '" & DateAdd("d", 1, strData) & "'"
        Set rsTerms = cnTerms.Execute(strSQL)
        Do Until rsTerms.EOF
            Clear_Block
            Set Flds = rsTerms.Fields
                ...
                If udtBlock.Duration = "Permanent" Then
                    If DateDiff("n", udtAppointment.SchedTime, udtBlock.StartTime) >= 0 Then
                        If DateDiff("n", DateAdd("n", lngDuration, udtAppointment.SchedTime), udtBlock.EndTime) <= 0 Then
    ...
    If mstrValidAppoint = "Invalid Appointment" Then
        iAnswer = MsgBox("This Appointment time  for this provider has been blocked for" _
            & " " & IsProperCase(udtBlock.Reason) & ". Do you want to continue scheduling this appointment?", vbYesNo, "PatientTrac Appointment Scheduling")
        If iAnswer = vbYes Then
            mstrValidAppoint = "Authorized"
        Else
            mstrValidAppoint = "Invalid Appointment"
...
Dim Idx As Integer
    ...
    If cnReferral.State = adStateClosed Then cnReferral.open psConnect(0)
    Screen.MousePointer = vbHourglass
    strSQL = "SELECT  REFERRAL_ID, REFERRAL_REASON, BILLING_ID FROM SUPERBILL WHERE PATIENT_ID = " & Val(udtSchedPatient.IntId)
    Set rsReferral = cnReferral.Execute(strSQL)
    With rsReferral
        Do Until .EOF
            If Not IsNull(!Referral_ID) Then
