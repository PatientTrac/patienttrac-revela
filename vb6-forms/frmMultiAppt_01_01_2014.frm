...
Begin VB.Form frmMultiAppt 
   ...
   Begin VB.Frame fraControl 
      ...
      Visible         =   0   'False
      Width           =   10875
      Begin VB.ComboBox cboVisitType 
         Height          =   330
         Left            =   6450
      ...
      Begin VB.ComboBox cboLocation 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmMultiAppt.frx":08CA
         Left            =   210
         List            =   "frmMultiAppt.frx":08CC
         Style           =   2  'Dropdown List
         TabIndex        =   36
         Top             =   570
         Width           =   4860
      ...
      Begin VB.ComboBox cboDayWeek 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmMultiAppt.frx":08CE
         Left            =   4290
         List            =   "frmMultiAppt.frx":08E7
         Style           =   2  'Dropdown List
         TabIndex        =   24
         Top             =   2070
         Width           =   1845
      ...
      Begin VB.ComboBox cboRepAppt 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmMultiAppt.frx":092B
         Left            =   2280
         List            =   "frmMultiAppt.frx":093B
         Style           =   2  'Dropdown List
         TabIndex        =   22
         Top             =   2070
         Width           =   1695
      ...
      Begin PT_XP_Button.PT_XP cmdSched 
         ...
         PictureDisabled =   "frmMultiAppt.frx":0CF3
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdExit 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmMultiAppt.frx":1A57
         ShowFocus       =   -1  'True
      End
   ...
   Begin VB.Frame fraNumber 
      ...
      Begin PT_XP_Button.PT_XP cmdAccept 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmMultiAppt.frx":27BB
         ShowFocus       =   -1  'True
      End
   End
   Begin PT_XP_Button.PT_XP cmdRemoveRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":30A7
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdGridRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":3993
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdPrint 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":427F
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdResource 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMultiAppt.frx":45D1
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmMultiAppt.frx":4B6B
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdProvTypes 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmMultiAppt.frx":4EBD
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmMultiAppt.frx":5457
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdMultiClose 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":61BB
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdMultiSave 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":68A7
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdPatient 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":7193
      ShowFocus       =   -1  'True
   End
   Begin FPSpreadADO.fpSpread grdMultiAppt 
      ...
      ShadowDark      =   8388608
      ShadowText      =   8388608
      SpreadDesigner  =   "frmMultiAppt.frx":74E5
      UserResize      =   0
      Appearance      =   2
      ClipboardOptions=   0
      CellNoteIndicator=   3
   ...
   Begin PT_XP_Button.PT_XP cmdConflict 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":7F80
      ShowFocus       =   -1  'True
   End
   Begin FPSpreadADO.fpSpread grdRepeatHist 
      ...
      ShadowDark      =   8388608
      ShadowText      =   8388608
      SpreadDesigner  =   "frmMultiAppt.frx":82D2
      UserResize      =   0
      Appearance      =   2
      TextTip         =   4
      TextTipDelay    =   100
   ...
   Begin PT_XP_Button.PT_XP cmdNewRepeat 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":8D66
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdUpdate 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":9652
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdDelete 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmMultiAppt.frx":9D3E
      ShowFocus       =   -1  'True
   End
    ...
    With rsAppt
        If Not rsAppt.EOF Then
            ...
            If Not IsNull((!VISIT_TYPE)) Then
                If (!VISIT_TYPE) <> vbNullString Then udtAppointment.SchedType = (!VISIT_TYPE)
            End If
        End If
    End With
...
Dim lngFacID As Long
    ...
    If LCase(udtTelephone.CallType) = "vendor" Then
        strPatType = "business"
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE, PROVIDER_TITLE, CPT_CODE " _
            & "FROM APPOINTMENT_TYPE WHERE VISIT_TYPE like '" & strPatType & "%'  ORDER BY  APPT_CODE, VISIT_TYPE"
    Else
        strPatType = "established patient"
        strSQL = "SELECT DISTINCT VISIT_TYPE, APPT_CODE, PROVIDER_TITLE, CPT_CODE " _
            & "FROM APPOINTMENT_TYPE WHERE VISIT_TYPE like '" & strPatType & "%' AND PROVIDER_TITLE = '" & strCompare & "' ORDER BY  APPT_CODE, VISIT_TYPE"
    End If
    Set rsCodes = cnCodes.Execute(strSQL)
    With rsCodes
        Do Until .EOF
            strApptCode = vbNullString
            strCPTCode = vbNullString
                ...
                If Not IsNull(Fld.Value) Then
                    If Trim(Fld.Value) <> vbNullString Then
                        Select Case UCase(Fld.Name)
                            ...
                            Case "CPT_CODE"
                                strCPTCode = Trim(Fld.Value)
                        End Select
                    End If
                End If
            Next
            .MoveNext
            strApptCode = strApptCode & " - " & strCPTCode
            cboVisitType.AddItem Trim(strApptCode)
        Loop
    End With
...
Dim bRowFound As Boolean
                ...
                If .BackColor = grdCurItem Then
                    ...
                    If UBound(Arr) >= 0 Then
                        ...
                        If lngCol > 0 Then
                            .GetText lngCol, lngRow, varCellValue
                            If IsDate(varCellValue) Then
                                udtRepeatAppt.RepeatID = varCellValue
                            End If
                        End If
                    End If
                    lngCol = 0
    ...
    If udtRepeatAppt.RepeatID > 0 Then
        ...
        strSQL = "Get_Appointment_Appt_ID " & udtRepeatAppt.RepeatID
        Set rsCodes = cnCodes.Execute(strSQL)
        With rsCodes
        ...
        strSQL = "Update_Appointment_Date_Time '" & Format(strApptDate, "mm/dd/yyyy") & "', '" _
            ...
            & Literals(udtRepeatAppt.Comment, "'") & "'," & udtRepeatAppt.RepeatID
        Set rsCodes = cnCodes.Execute(strSQL)
...
Dim strTerms As String
    ...
    With rsCodes
        If Not .EOF Then
            udtRepeatAppt.RepeatID = (!Appt_ID)
        End If
    End With
    ...
    Else
        strSQL = "UPDATE APPOINTMENTS SET PURPOSE_VISIT = '" & udtRepeatAppt.PurposeVisit & "', " _
            ...
            & "PATIENT_TYPE = '" & udtAppointment.SchedType & "', APPT_TYPE = '" & udtRepeatAppt.ApptType & "', " _
            & "TERMINATION_DATE = '" & udtRepeatAppt.EndDate & "',DURATION = '" & udtRepeatAppt.Duration & "', " _
            & "REPEAT_APPOINT = " & udtRepeatAppt.RepeatID & ", ACTIVE = 1 " _
            & "WHERE APPT_ID = " & udtRepeatAppt.RepeatID
        Set rsCodes = cnCodes.Execute(strSQL)
    End If
    If cnCodes.State = adStateOpen Then
        cnCodes.Close
...
Dim strTerms As String
    ...
    strSQL = "SELECT * FROM PATIENT_REPEAT_APPT where PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
        & "PATIENT_TYPE = '" & udtTelephone.CallType & "'  AND " _
        & "FACILITY_ID = " & udtRepeatAppt.FacilityID & " AND " _
    ...
    If udtRepeatAppt.RepeatID = 0 Then
        strSQL = "INSERT INTO PATIENT_REPEAT_APPT (PATIENT_ID, FACILITY_ID, PROVIDER_ID, " _
            ...
            & "REPEAT_FREQ, DURATION, REPEAT_MODE, PATIENT_TYPE, REPEAT_DAY_WEEK, COMMENT, ACTIVE) VALUES " _
            ...
            & udtRepeatAppt.ApptType & "','" & Format(udtRepeatAppt.StartTime, "hh:mm AM/PM") & "','" _
            ...
            & udtRepeatAppt.Duration & "', '" & udtTelephone.CallType & "', '" & udtRepeatAppt.RepeatMode & "', '" & udtRepeatAppt.WeekDay & "', '" & udtRepeatAppt.Comment & "', 1)"
        Set rsCodes = cnCodes.Execute(strSQL)
        strSQL = "SELECT * FROM PATIENT_REPEAT_APPT where PATIENT_ID = " & Val(udtSchedPatient.IntId) & " AND " _
            & "PATIENT_TYPE = '" & udtTelephone.CallType & "'  AND " _
            & "FACILITY_ID = " & udtRepeatAppt.FacilityID & " AND " _
...
Dim lngCol As Long
    ...
    If grdMultiAppt.MaxRows > 0 Then
        MsgBox "Use Terminate Repeat Appointments below to remove this data!", vbInformation, "PatientTrac Repeat Appointments"
        Screen.MousePointer = vbDefault
...
Dim Idx%
    ...
    If cboVisitType.ListIndex = -1 Then
       ...
       Exit Sub
    Else
        udtRepeatAppt.PurposeVisit = Trim(cboVisitType)
    End If
...
Dim lngEndDate As Long
    ...
    Select Case IsProperCase(udtTelephone.CallType)
        ...
        Case "Physician"
            ...
            udtAppointment.SchedType = "Physician"
    End Select
        ...
        Select Case cboRepAppt.Text
                    ...
                    For Idx = 0 To lngDateDiff
                        ...
                        If Trim(udtRepeatAppt.ApptDate) <> vbNullString Then
                            ...
                            If lngEndDate >= 0 Then
                                Write_Repeat_Appt
                                If Get_SchedConflict(udtRepeatAppt.ApptDate, udtRepeatAppt.ApptTime) Then
                                    If cctBlockConflict.Text = vbNullString Then
                                        cctBlockConflict.Text = "These Appointments conflict with Block Times" & vbNewLine & udtRepeatAppt.ApptDate & " " & udtRepeatAppt.ApptTime
                                    Else
                        ...
                        If udtRepeatAppt.StartDate <> vbNullString Then
                            ...
                            Select Case udtRepeatAppt.WeekDay
                                ...
                                Case "Tuesday"
                                    ...
                                    udtRepeatAppt.ApptDate = DateAdd("d", nDays - (FirstDay - 1), udtRepeatAppt.ApptDate)
                                Case "Wednesday"
                    ...
                    For Idx = 0 To lngDateDiff
                        If udtRepeatAppt.ApptDate <> vbNullString Then
                            Select Case udtRepeatAppt.WeekDay
                                Case "Monday"
                                    FirstDay = WeekDay(udtRepeatAppt.ApptDate, vbMonday)
                                    udtRepeatAppt.ApptDate = DateAdd("m", -FirstDay, udtRepeatAppt.ApptDate)
                                    strTestMonth = Month(udtRepeatAppt.ApptDate)
                                Case "Tuesday"
                                    FirstDay = WeekDay(udtRepeatAppt.ApptDate, vbTuesday)
                                    udtRepeatAppt.ApptDate = DateAdd("m", -(FirstDay - 1), udtRepeatAppt.ApptDate)
                                    strTestMonth = Month(udtRepeatAppt.ApptDate)
                                Case "Wednesday"
                                    FirstDay = WeekDay(udtRepeatAppt.ApptDate, vbWednesday)
                                    udtRepeatAppt.ApptDate = DateAdd("m", -(FirstDay - 1), udtRepeatAppt.ApptDate)
            ...
            Case "Annual"
                ...
                If lngDateDiff > 0 Then
                    ...
                    Else
                        udtRepeatAppt.ApptDate = Format(udtAppointment.SchedDate, "mm/dd/yyyy")
                    End If
                    For Idx = 1 To lngDateDiff
                        udtRepeatAppt.ApptDate = DateAdd("yyyy", Idx, udtRepeatAppt.ApptDate)
                        If udtRepeatAppt.ApptDate <> vbNullString Then
                            Select Case udtRepeatAppt.WeekDay
                                Case "Monday"
                                    FirstDay = WeekDay(udtRepeatAppt.ApptDate, vbMonday)
...
Dim Arr
    ...
    strSQL = "SELECT  PATIENT_REPEAT_APPT.*, APPOINTMENTS.* FROM PATIENT_REPEAT_APPT " _
        ...
        & "WHERE PATIENT_REPEAT_APPT.ACTIVE = 1 AND APPOINTMENTS.PATIENT_TYPE = '" & udtTelephone.CallType & "' AND PATIENT_REPEAT_APPT.REPEAT_ID = " & udtRepeatAppt.RepeatID
            ...
            Do Until .EOF
                ...
                If Trim(udtRepeatAppt.ApptDate) <> vbNullString Then
                    ...
                    If UBound(Arr) >= 0 Then
                       lngCol = Arr(0)
                       If lngCol > 0 Then
                          Format_CellTypeEdit grdMultiAppt, lngRow, lngCol, "1", CStr(udtRepeatAppt.RepeatID), "TypeHAlignCenter", "APPT_ID"
                       End If
                    End If
...
Dim Arr
    ...
    With grdMultiAppt
        ...
        grdMultiAppt.ColWidth(4) = 15
        grdMultiAppt.ColWidth(5) = 10
        grdMultiAppt.ColWidth(6) = 9
        grdMultiAppt.ColWidth(7) = 9
        grdMultiAppt.ColWidth(8) = 12
        grdMultiAppt.ColWidth(9) = 17
        grdMultiAppt.ColWidth(10) = 0
        .MaxRows = 0
        .Row = SpreadHeader
        .Col = 10
        .ColHidden = True
            ...
            Select Case .CellTag
                ...
                Case "APPT_TIME"
                    If cboRepTime.listcount <= 0 Then
                         If UCase(clsApptPref.SchedInterval) = "EVERY 10 MIN" Then
