...
Begin VB.Form PatientInfo 
   ...
   Begin VB.Frame fraPatient 
      ...
      Top             =   30
      Width           =   12075
      Begin VB.ComboBox cboEthinicity 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":0DBE
         Left            =   1965
         List            =   "PatientInfo.frx":0DCB
      ...
      Begin VB.Frame fraStatus 
         ...
         Visible         =   0   'False
         Width           =   5415
         Begin VB.TextBox cctRoomNumber 
            Alignment       =   2  'Center
            BackColor       =   &H00FFFFFF&
            ForeColor       =   &H00000000&
            Height          =   375
            ...
            Width           =   1650
         End
         Begin VB.TextBox cctStatusNote 
            Height          =   780
            Left            =   210
            MultiLine       =   -1  'True
            ...
            Width           =   5010
         End
         Begin VB.ComboBox cboFacStatus 
            ForeColor       =   &H00000000&
            Height          =   330
            Left            =   210
            Style           =   2  'Dropdown List
            ...
            Width           =   5055
         End
         Begin PT_XP_Button.PT_XP cmdSaveStatus 
            Height          =   345
            Left            =   1455
            TabIndex        =   121
            Top             =   2520
            ...
            PictureDisabled =   "PatientInfo.frx":119E
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdExit 
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "PatientInfo.frx":1F02
            ShowFocus       =   -1  'True
         End
         ...
         Begin VB.Label lblStatus 
            ...
            Width           =   1185
         End
         Begin VB.Label lblCurStatus 
            AutoSize        =   -1  'True
            BackColor       =   &H00E0E0E0&
            Caption         =   "Current Facility Status"
            BeginProperty Font 
               Name            =   "Georgia"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.ComboBox cboPatMarital 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":2254
         Left            =   1965
         List            =   "PatientInfo.frx":2256
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   5730
         Width           =   3135
      ...
      Begin VB.ComboBox cboPatientRace 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":2B22
         Left            =   1965
         List            =   "PatientInfo.frx":2B24
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   4890
         Width           =   2145
      ...
      Begin VB.Frame fraPartName 
         ...
         Begin PT_XP_Button.PT_XP cmdParOk 
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "PatientInfo.frx":3D14
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdPartCancel 
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "PatientInfo.frx":4A78
            ShowFocus       =   -1  'True
         End
      ...
      Begin VB.ComboBox cboLanguage 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":4DCA
         Left            =   4515
         List            =   "PatientInfo.frx":4DCC
         Style           =   2  'Dropdown List
         TabIndex        =   13
      ...
      Begin VB.ComboBox cboPrefContact 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":4DCE
         Left            =   6540
         List            =   "PatientInfo.frx":4DDB
         Style           =   2  'Dropdown List
         TabIndex        =   16
         Top             =   450
         Width           =   1965
      ...
      Begin VB.ComboBox cboStatus 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":4E03
         Left            =   6570
         List            =   "PatientInfo.frx":4E10
         Style           =   2  'Dropdown List
         TabIndex        =   28
         Top             =   3660
         Width           =   1995
      ...
      Begin VB.ComboBox cboBloodType 
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "PatientInfo.frx":4E30
         Left            =   1980
         List            =   "PatientInfo.frx":4E4C
         Style           =   2  'Dropdown List
         TabIndex        =   11
         Top             =   4500
         Width           =   1305
      ...
      Begin PT_XP_Button.PT_XP cmdNew 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":5412
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdUpdate 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":5CFE
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdCancel 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":63EA
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdClose 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":714E
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdSave 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":783A
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdTakePic 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":8466
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdPrint 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":9652
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdStatus 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "PatientInfo.frx":9F3E
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdEthinic 
         Height          =   225
         Left            =   1470
         TabIndex        =   130
         ToolTipText     =   "Manage Race Terms"
...
Private Function Get_Room_Number()
...
Dim lngAdmit_ID As Long
    ...
    strSQL = "Get_InPatient_Room " & piPatientID & "," & clsFacStatus.FacilityID
        Set rsReadAppt = cnReadAppt.Execute(strSQL)
        With rsReadAppt
            If Not .EOF Then
                If Not IsNull((!room)) Then
                    cctRoomNumber.Text = Trim((!room))
                End If
            End If
        End With
...
Dim strValidate As String
        ...
        Do Until .EOF
            ...
            If Trim(strName) <> vbNullString Then
                ...
                If Not booSkip Then
                    ...
                    cboFacStatus.AddItem strName
                    If lngFacID > 0 Then
                        cboFacility.ItemData(cboFacility.NewIndex) = lngFacID
                        cboFacStatus.ItemData(cboFacStatus.NewIndex) = lngFacID
                    End If
                End If
            End If
        Loop
    ...
    If clsEDI_Client.Site_ID = "1999" Then
        If udtInPatSched.Facility_ID = 0 And Val(udtSchedPatient.IntId) > 0 Then
            Read_Patient_Status Val(udtSchedPatient.IntId)
        ElseIf Val(udtSchedPatient.IntId) > 0 And clsFacStatus.FacilityID = 0 Then
            Read_Patient_Status Val(udtSchedPatient.IntId)
            'clsFacStatus.FacilityID = udtInPatSched.Facility_ID
        ElseIf clsFacStatus.FacilityID = 0 Then
            clsFacStatus.FacilityID = udtInPatSched.Facility_ID
        End If
        If cboFacility.listcount > 0 Then
            For Idx = 0 To cboFacility.listcount - 1
                If cboFacility.ItemData(Idx) = clsFacStatus.FacilityID Then
                   ' mbooByPass = True
        ...
        End If
    Else
        strName = Get_Current_Facility(piPatientID)
        If strName <> vbNullString Then
            For Idx = 0 To cboFacility.listcount - 1
                If cboFacility.List(Idx) = strName Then
                    mbooByPass = True
                    cboFacility.Text = cboFacility.List(Idx)
                    Exit For
                End If
...
Private Sub Clear_Fields()
    ...
    cboFacStatus.ListIndex = -1
    cctStatusNote.Text = vbNullString
...
Dim sStr As String
   ...
   If cnTerms.State = adStateClosed Then cnTerms.open psConnect(1)
    vobjCombo.Clear
    sStr = "Get_Attr_Valid_Value_SubDom_Alphabetic'" & vstrSubDomain & "'"
    Set rsTerms = cnTerms.Execute(sStr)
    With rsTerms
        Do Until .EOF
            sStr = vbNullString
            sStr = Trim(!ATTRBTE_VALID_VALUE)
            .MoveNext
            If Trim(sStr) <> vbNullString Then
                vobjCombo.AddItem Trim(sStr)
            End If
        Loop
    End With
...
Error_GetTerms:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, sStr, "GetTerms", App.EXEName & "." & "ModGeneral"
    Exit Sub
    Resume
End Sub


Private Function Save_Non_Selected_Status()
Dim strSQL As String
...
Dim lngPatID As Long
    ...
    On Error GoTo Error_Save_Non_Selected_Status
    Screen.MousePointer = vbHourglass
...
'            mNewPatient = False
'        Else
'            MsgBox "Please complete patient name first!, PatientTrac saves this new patient first before creating an facility status.", vbInformation, "PatientTrac Patient Data"
'            Screen.MousePointer = vbDefault
'            Exit Sub
'        End If
'    Else
...
'    End If
    For i = 0 To cboFacility.listcount - 1
        If cboFacility.List(i) = cboFacility.Text Then
            clsFacStatus.FacilityID = cboFacility.ItemData(i)
            Exit For
        End If
    Next i
    clsFacStatus.StatusDesc = Trim(cctStatusNote.Text)
    strTime = Format(Now, "mm/dd/yyyy")
    strStart = Format(strTime, "mm/dd/yyyy 00:00:00 AM/PM")
    strEnd = Format(strStart, "mm/dd/yyyy")
    strEnd = DateAdd("h", 23, strStart)
    strEnd = Format(strEnd, "mm/dd/yyyy hh:mm:ss AM/PM")
    If cnPatient.State = adStateClosed Then cnPatient.open psConnect(0)
    strSQL = "Get_Patient_Status_Range " & piPatientID & ",'" & Format(strStart, "mm/dd/yyyy") & "', '" & Format(strEnd, "mm/dd/yyyy") & "'"
        Set rsPatient = cnPatient.Execute(strSQL)
    With rsPatient
        If Not .EOF Then
            lngPrimKey = (!PATIENT_STATUS_ID)
        End If
    End With
    cnPatient.Close
    If Trim(clsFacStatus.StatusDesc) <> vbNullString Then
        clsFacStatus.StatusDesc = Replace(clsFacStatus.StatusDesc, "'", "''")
    End If
    If cnPatient.State = adStateClosed Then cnPatient.open psConnect(0)
    If lngPrimKey > 0 Then
        strSQL = "Update_Patient_Status  '" & CStr(clsFacStatus.FacilityID) & "', '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "', '" _
            & clsFacStatus.StatusDesc & "'," & lngPrimKey
        Set rsPatient = cnPatient.Execute(strSQL)
    Else
        strSQL = "Insert_Patient_Status " & piPatientID & ",'" _
            & CStr(clsFacStatus.FacilityID) & "','" & clsFacStatus.StatusDesc & "', '" _
            & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "'"
        Set rsPatient = cnPatient.Execute(strSQL)
    End If
'    Read_Patient_Status piPatientID
'    If clsFacStatus.FacilityID > 0 Then
'        For i = 0 To cboFacStatus.listcount - 1
'            If cboFacStatus.ItemData(i) = clsFacStatus.FacilityID Then
'                cboFacStatus.Text = cboFacStatus.List(i)
'                Exit For
'            End If
'        Next i
'        If cboFacility.listcount > 0 Then
'            For i = 0 To cboFacility.listcount - 1
'                If cboFacility.ItemData(i) = clsFacStatus.FacilityID Then
'                    mbooByPass = True
...
'    End If
'    If Trim(clsFacStatus.StatusDesc) <> vbNullString Then
'        cctStatusNote.Text = Trim(clsFacStatus.StatusDesc)
'    End If
'    If Trim(cctRoomNumber.Text) <> vbNullString Then
'        Save_Patient_Room
'    End If
'    cboFacStatus.Locked = True
'    cctStatusNote.Locked = True
'    cmdStatus.Visible = True
 '   End If
    'fraStatus.Visible = False
    Screen.MousePointer = vbDefault
   Exit Function
Error_Save_Non_Selected_Status:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Save_Non_Selected_Status", "PatientTracSchedule.PatientInfo"
    Exit Function
    Resume
End Function

Private Function Save_Patient_Room()
Dim cnReadAppt As New ADODB.Connection
Dim rsReadAppt  As New ADODB.Recordset
Dim strSQL As String
Dim lngPurge As Double
Dim lngAdmit_ID As Long
    ...
    On Error GoTo Error_Save_Patient_Room
    If cnReadAppt.State = adStateClosed Then cnReadAppt.open psConnect(0)
    strSQL = "Get_InPatient_Room " & piPatientID & "," & clsFacStatus.FacilityID
        Set rsReadAppt = cnReadAppt.Execute(strSQL)
        With rsReadAppt
        ...
        If lngAdmit_ID > 0 Then
            strSQL = "Update_InPatient_Room '" & Trim(cctRoomNumber.Text) & "'," & lngAdmit_ID
            Set rsReadAppt = cnReadAppt.Execute(strSQL)
        Else
            strSQL = "Insert_InPatient_Room_Patient " & piPatientID & ", " & clsFacStatus.FacilityID & ",'" & Trim(cctRoomNumber.Text) & "'"
            Set rsReadAppt = cnReadAppt.Execute(strSQL)
        End If
    If cnReadAppt.State = adStateOpen Then
        cnReadAppt.Close
    ...
    Screen.MousePointer = vbDefault
    Exit Function
Error_Save_Patient_Room:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Save_Patient_Room", App.EXEName & "." & Me.Name
    Exit Function
    Resume
End Function
...
Dim sDate As String
    ...
    Screen.MousePointer = vbHourglass
    strSQL = "Get_Patient_BY_Id " & piPatientID
    Set rsPatient = cnPatient.Execute(strSQL)
            ...
            If Not IsNull(Fld.Value) Then
                If Trim(Fld.Value) <> vbNullString Then
                    Select Case UCase(Fld.Name)
                        ...
                        Case UCase("title")
                            If Fld.Value <> vstrTitle Then booSave = True
                        Case UCase("first_name")
                            If Fld.Value <> vstrPatFName Then booSave = True
                        Case UCase("middle_name")
                            If Fld.Value <> vstrPatMName Then booSave = True
                        Case UCase("last_name")
                            If Fld.Value <> vstrPatLName Then booSave = True
                        Case UCase("address1")
                            If Fld.Value <> vstrPatAddress Then booSave = True
                        Case UCase("address2")
                            If Fld.Value <> vstrPatAddress2 Then booSave = True
                        Case UCase("city")
                            If Fld.Value <> vstrPatCity Then booSave = True
                        Case UCase("state")
                            If Fld.Value <> vstrPatState Then booSave = True
                        Case UCase("zipcode")
                            If Fld.Value <> vstrPatZip Then booSave = True
                        Case UCase("zipcode_ext")
                            If Fld.Value <> vstrPatZipExt Then booSave = True
                        Case UCase("country")
                            If Fld.Value <> vstrPatCountry Then booSave = True
                        Case UCase("area_code")
                            If Fld.Value <> vstrAreaCode Then booSave = True
                        Case UCase("phone")
                            If Fld.Value <> vstrPhone Then booSave = True
                        Case UCase("cell_phone")
                            If Fld.Value <> vstrCellPhone Then booSave = True
                        Case UCase("drv_license")
                            If Fld.Value <> vstrDL Then booSave = True
                        Case UCase("Race")
                            If Fld.Value <> vstrRace Then booSave = True
                        Case UCase("Status")
                            If Fld.Value <> vstrStatus Then booSave = True
                        Case UCase("Suffix")
                            If Fld.Value <> vstrPatSuffix Then booSave = True
                        Case UCase("birth")
                            If Fld.Value <> vstrBirth Then booSave = True
                        Case UCase("social_security")
                            If Fld.Value <> vstrSocSec Then booSave = True
                        Case UCase("gender")
                            If Fld.Value <> vstrGender Then booSave = True
                        Case UCase("email")
                            If Fld.Value <> vstrEmailAddress Then booSave = True
                        Case UCase("internatl_phone")
                            If Fld.Value <> vstrIntnPhone Then booSave = True
                        Case UCase("county")
                            If Fld.Value <> vstrPatCounty Then booSave = True
                        Case UCase("blood_Type")
                            If Fld.Value <> vstrBloodType Then booSave = True
                        Case UCase("marital_status")
                            If Fld.Value <> vstrMaritalStat Then booSave = True
                        Case UCase("work_phone")
                            If Fld.Value <> vstrWorkPhone Then booSave = True
                        Case UCase("EMERGENCY_CONTACT")
                            If Fld.Value <> vstrEmerContact Then booSave = True
                        Case UCase("EMERG_PHONE")
                            If Fld.Value <> vstrEMERG_PHONE Then booSave = True
                        Case UCase("EMERG_RELATION")
                            If Fld.Value <> vstrEmergRel Then booSave = True
                    End Select
                End If
            End If
    ...
    Get_ArchiveData
    If cnPatient.State = adStateClosed Then cnPatient.open psConnect(0)
    strSQL = "S_PREVPATINFO " & piPatientID
    Set rsPatient = cnPatient.Execute(strSQL)
    ...
    Validate_Entries
    If lngPrimKey > 0 Then
        strSQL = "Update_Patient_Archive '" & udtPatientName.ExtID & "','" & udtPatientName.Title & "','" & udtPatientName.FirstName & "',' " _
            & udtPatientName.MiddleName & "', '" & udtPatientName.LastName & "', '" & udtPatientName.Race & "',' " _
            ...
            & udtPatientName.City & "','" & udtPatientName.State & "', '" & udtPatientName.Phone & "',' " _
            & udtPatientName.InterNalPhone & "', '" & udtPatientName.SS & "','" & udtPatientName.Marital_Status & "',' " _
            & udtPatientName.AreaCode & "', '" & Format(udtPatientName.DOB, "mm/dd/yyyy") & "', '" & udtPatientName.Language & "',' " _
            & Left(udtPatientName.Zip, 5) & "', '" & udtPatientName.Zip_Ext & "','" & Left(udtPatientName.Gender, 1) & "',' " _
            & udtPatientName.CellPhone & "','" & udtPatientName.WorkPhone & "','" & udtPatientName.Email & "','" & udtPatientName.DL & " ',' " _
            & PsUserID & "', '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "','" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "', " & lngPrimKey
            Set rsPatient = cnPatient.Execute(strSQL)
    Else
        strSQL = "Write_Patient_Archive " & piPatientID & ", '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "', '" & udtPatientName.ExtID & "','" & udtPatientName.Title & "','" _
            ...
            & udtPatientName.DL & "', '" & PsUserID & "','" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "'"
            Set rsPatient = cnPatient.Execute(strSQL)
    End If
...
Dim lngDateDiff As Long
    ...
    strSQL = "Write_Patient '" & clsPatient.ExtID & "','" & clsPatient.Title & "','" & clsPatient.FirstName & "','" _
        ...
        & clsPatient.DL & "', '" & PsUserID & "','" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "','" & clsPatient.Blood_Type & "'"
        Set rsPatInsert = cnPatInsert.Execute(strSQL)
    strSQL = "Get_Insert_Patient '" & clsPatient.LastName & "', '" & clsPatient.FirstName & "','" & strDate & "'"
    Set rsPatInsert = cnPatInsert.Execute(strSQL)
    With rsPatInsert
        If Not rsPatInsert.EOF Then
            piPatientID = (!Patient_ID)
...
Dim strSS As String
    ...
    clsPatient.FirstName = Replace(clsPatient.FirstName, "'", "''")
    clsPatient.LastName = Replace(clsPatient.LastName, "'", "''")
    strLastName = Replace(clsPatient.LastName, "'", "%")
    strSQL = "IsNewPatient '" & strLastName & "', '" & clsPatient.FirstName & "'"
    Set rsPatient = cnPatient.Execute(strSQL)
                ...
                If Trim(Fld.Value) <> vbNullString Then
                    Select Case UCase(Fld.Name)
                        Case "SOCIAL_SECURITY"
                            strSS = Fld.Value
                            If strSS <> "999-99-9999" Then
                                If clsPatient.SS = strSS Then
                                    IsNewPatient = False
                                    Exit Do
                                End If
                            End If
                        Case "BIRTH"
                            ...
                            If IsDate(strBirth) And strBirth <> "01/01/1900" And IsDate(clsPatient.DOB) Then
                                clsPatient.DOB = Format(clsPatient.DOB, "mm/dd/yyyy hh:mm:ss AM/PM")
...
Dim strSQL As String
    ...
    On Error GoTo Error_Update_ThirdParty
    Screen.MousePointer = vbHourglass
    ...
    Screen.MousePointer = vbDefault
    Exit Function
Error_Update_ThirdParty:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Update_ThirdParty", "PatientTracSchedule.PatientInfo"
    Exit Function
    Resume
End Function
...
Dim lngDateDiff As Long
    ...
    If Trim(clsPatient.FirstName) = vbNullString Then
      MsgBox "First name is required", vbExclamation, "PatientTrac Patient Information"
        Validate_Entries = False
    End If
    '
    If Trim(clsPatient.LastName) = vbNullString Then
      MsgBox "Last name is required", vbExclamation, "PatientTrac Patient Information"
        Validate_Entries = False
    ElseIf Trim(clsPatient.LastName) = vbNullString And Trim(clsPatient.Name) = vbNullString Then
          MsgBox "Patient name is required", vbExclamation, "PatientTrac Patient Information"
            Validate_Entries = False
    End If
...
Dim strAddress As String
        ...
        For i = 0 To cboFacility.listcount - 1
            If cboFacility.List(i) = cboFacility.Text Then
                ...
                If piFacilityID = 0 Then
                    strSQL = "Get_Facility_By_NAME '" & strFacilityName & "'"
                    Open_DB psConnect(0)
    ...
    If clsEDI_Client.Site_ID = "1999" Then
        If piFacilityID > 0 Then
            Get_Facilities piFacilityID
            If clsPatient.Address = vbNullString Then
                clsPatient.Address = Fix_Name(clsFacility.Address)
                clsPatient.Address2 = Fix_Name(clsFacility.Address2)
                clsPatient.City = Fix_Name(clsFacility.City)
                clsPatient.City = Replace(clsPatient.City, " - ", "-")
                clsPatient.City = Trim(clsPatient.City)
                clsPatient.County = Fix_Name(clsFacility.County)
                clsPatient.State = Fix_Name(clsFacility.State)
                clsPatient.Zip = Left(clsFacility.Zip, 5)
                clsPatient.Zip_Ext = Fix_Name(clsFacility.ZipExt)
...
Dim lRow As Long
Dim strList As String
    If Len(cboParTitle.Text) >= 1 Then
        strList = cboParTitle.Text
        cboParTitle.ListIndex = SendMessage(cboParTitle.Hwnd, LB_FINDSTRING, -1, _
        ByVal strList)
    End If
End Sub


Private Sub cboPartRel_KeyUp(KeyCode As Integer, Shift As Integer)
Dim strList As String
...
Dim lRow As Long
Dim strList As String
        If Len(cboPatientRace.Text) >= 1 Then
            strList = cboParTitle.Text
            cboPatientRace.ListIndex = SendMessage(cboPatientRace.Hwnd, LB_FINDSTRING, -1, _
            ByVal strList)
        End If
    Exit Sub
End Sub
...
Dim strSQL As String
    ...
    If cboStatus.Text = "DECEASED" Then
        ...
        fraDOD.Visible = True
    Else
        If ccdDateDeath.Enabled Then
            ccdDateDeath.Value = vbNullString
            ccdDateDeath.CheckBox = False
            ccdDateDeath.Enabled = False
            fraDOD.Visible = False
            strSQL = "UPDATE PATIENT SET OTHER_INFO3 = '', PURGE = 0, STATUS  = 'Active' WHERE PATIENT_ID = " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
            clsPatient.Status = "Active"
        End If
    End If
    If cnPatient.State = adStateOpen Then
        cnPatient.Close
...
Error_cboStatus:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "cboStatus", "PatientTracSchedule.PatientInfo"
    Exit Sub
    Resume
End Sub
...
Dim Idx%
    ...
    On Error GoTo Error_Save_Patient
    Screen.MousePointer = vbHourglass
    ...
    Else
        For Idx = 0 To cboFacility.listcount - 1
            If cboFacility.Text = cboFacility.List(Idx) Then
                udtInPatSched.Facility_ID = cboFacility.ItemData(Idx)
                Exit For
            End If
        Next Idx
    End If
    piFacilityID = udtInPatSched.Facility_ID
    If fraStatus.Visible Then
        MsgBox "Please save facility status, select" & " " & Chr(34) & "Apply" & Chr(34), vbInformation, "PatientTrac Patient"
        Screen.MousePointer = vbDefault
        Exit Sub
    End If
    ...
    Next Idx
    piFacilityID = udtInPatSched.Facility_ID
    If clsEDI_Client.Site_ID = "1999" And clsFacStatus.FacilityID = 0 Then
        MsgBox "Please complete facility status with room number", vbInformation, "New Patient"
        For Idx = 0 To cboFacStatus.listcount - 1
            If cboFacStatus.ItemData(Idx) = piFacilityID Then
                cboFacStatus.Text = cboFacStatus.List(Idx)
                Exit For
            End If
        Next Idx
        fraStatus.Visible = True
        cboFacStatus.Locked = False
        cctStatusNote.Locked = False
        Screen.MousePointer = vbDefault
        Exit Sub
    ElseIf clsEDI_Client.Site_ID = "1999" And Validate_CurrentFacility(piPatientID) Then
        Save_Non_Selected_Status
    End If
    Screen.MousePointer = vbDefault
    Unload Me
    Exit Sub
Error_Save_Patient:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, "", "Save_Patient", "PatientTrac.PatientInfo"
    Exit Sub
     Resume Next
End Sub
...
Private Sub cmdSaveStatus_Click()
Dim strSQL As String
Dim strEnctrStart As String
Dim cnPatient As New ADODB.Connection
Dim rsPatient As New ADODB.Recordset
...
Dim lngPatID As Long
    ...
    On Error GoTo Error_Save_Status
    Screen.MousePointer = vbHourglass
    If mNewPatient = True Then
        If txtFullName.Text <> vbNullString And clsPatient.LastName <> vbNullString Then
            lngPatID = Save_Data
            If lngPatID = 0 Then
                MsgBox "Unable to save patient, please correct errors and save!", vbInformation, "PatientTrac Demographics"
                Screen.MousePointer = vbDefault
                Exit Sub
            Else
                Get_Patient lngPatID
    ...
    End If
    For i = 0 To cboFacStatus.listcount - 1
        If cboFacStatus.List(i) = cboFacStatus.Text Then
            clsFacStatus.FacilityID = cboFacStatus.ItemData(i)
            Exit For
        End If
    Next i
    clsFacStatus.StatusDesc = Trim(cctStatusNote.Text)
...
Error_Save_Status:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, strSQL, "Save_Status", "PatientTracSchedule.PatientInfo"
    Exit Sub
    Resume
End Sub
...
Error_Picture:
    Screen.MousePointer = vbDefault
    Write_Error Err.Description, Err.Number, "", "Picture", "PatientTracSchedule.PatientInfo"
    Exit Sub
    Resume
End Sub
...
Dim Idx%
    ...
    If mFirst Then
        ...
        Clear_Fields
        Clear_Emerg
        If IsNumeric(udtSchedPatient.IntId) Then lngPatID = udtSchedPatient.IntId
        ...
        GetTerms cboPatientRace, "sd_Patient_Race"
        GetTerms cboPatMarital, "sd_Patient_MaritalStat"
        GetTerms cboParTitle, "sd_Patient_Title"
        If mNewPatient = False Then
            If lngPatID > 0 Then piPatientID = lngPatID
            Set_Patient
        Else
            ...
            If clsEDI_Client.Site_ID = "1999" Then
                If udtInPatSched.Facility_ID > 0 Then
                    ...
                    End If
                End If
                If cboFacStatus.listcount > 0 Then
                    For i = 0 To cboFacStatus.listcount - 1
                        If cboFacStatus.ItemData(i) = clsFacStatus.FacilityID Then
                            mbooByPass = True
                            cboFacStatus.Text = cboFacStatus.List(i)
        ...
        If cboStatus.Text = vbNullString Then
            For Idx = 0 To cboStatus.listcount - 1
                If IsProperCase(cboStatus.List(Idx)) = "Active" Then
                    cboStatus.Text = cboStatus.List(Idx)
                    Exit For
                End If
            Next Idx
        End If
...
Dim lngDateDiff As Long
    ...
    If Validate_Entries Then
        ...
        clsPatient.Email = Literals(Trim(clsPatient.Email), "'")
        ...
        If Trim(clsPatient.DOB) <> vbNullString Then
            clsPatient.DOB = Format(clsPatient.DOB, "mm/dd/yyyy hh:mm:ss AM/PM")
            lngDateDiff = DateDiff("yyyy", Format(clsPatient.DOB, "mm/dd/yyyy"), Format(Now, "mm/dd/yyyy"))
            If lngDateDiff > 150 Or lngDateDiff < 0 Then
                MsgBox "Invalid Date of Birth, Patient age =" & " " & CStr(lngDateDiff) & " " & "Please enter correct Date of Birth", vbCritical, "PatientTrac Patient Demographics"
                Screen.MousePointer = vbDefault
                mbNotSave = True
                Exit Function
            End If
        ...
        If Trim(txtEmergContact.Text) <> vbNullString Then
            ...
            clsPatient.EmergContact = Replace(clsPatient.EmergContact, "'", "''")
            strSQL = "Update_Patient_Emergency '" & clsPatient.EmergContact & "', '" & clsPatient.EmergPhone & "',' " _
                 & clsPatient.EmergRelation & "', " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        If ccdDateDeath.CheckBox And Not IsNull(ccdDateDeath.Value) Then
            clsPatient.DateDeath = Format(ccdDateDeath.Value, "mm/dd/yyyy")
            strSQL = "Update_Patient_Date_Death '" & clsPatient.DateDeath & "', " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        If Trim(clsPatient.Ethnicity) <> vbNullString Then
            strSQL = "UPDATE PATIENT SET ETHNICITY =  '" & clsPatient.Ethnicity & "' WHERE PATIENT_ID =  " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
    Else
        Save_Data = 0
...
Dim i%
    ...
    If Validate_Entries Then
        ...
        clsPatient.Ethnicity = Trim(cboEthinicity)
        ...
        If Trim(txtEmergContact) <> vbNullString Then
            ...
            clsPatient.EmergPhone = Trim(txtEmergAC.Text) & "-" & Trim(txtEmergPh1.Text) & "-" & Trim(txtEmergPh2.Text)
            clsPatient.EmergContact = Replace(clsPatient.EmergContact, "'", "''")
            strSQL = "Update_Patient_Emergency '" & clsPatient.EmergContact & "','" & clsPatient.EmergContact & "','" _
                & clsPatient.EmergRelation & "'," & piPatientID
                Set rsPatient = cnPatient.Execute(strSQL)
        End If
        ...
        If cnPatient.State = adStateClosed Then cnPatient.open psConnect(0)
        strSQL = "Update_Patient '" & clsPatient.ExtID & "','" & clsPatient.Title & "','" & clsPatient.FirstName & "',' " _
                & clsPatient.MiddleName & "', '" & clsPatient.LastName & "','" & clsPatient.Race & "','" _
                & clsPatient.PrefContact & "','" & clsPatient.Status & "','" & clsPatient.County & "','" _
                & clsPatient.Suffix & "','" & clsPatient.Address & "','" & clsPatient.Address2 & "','" _
                & clsPatient.City & "','" & Trim(clsPatient.State) & "','" & clsPatient.Phone & "','" _
                & clsPatient.InterNalPhone & "', '" & clsPatient.SS & "','" & clsPatient.Marital_Status & "','" _
                & clsPatient.AreaCode & "','" & clsPatient.DOB & "','" & clsPatient.Language & "','" _
                & Left(clsPatient.Zip, 5) & "','" & clsPatient.Zip_Ext & "','" & Left(clsPatient.Gender, 1) & "','" _
                & clsPatient.CellPhone & "','" & clsPatient.WorkPhone & "','" & clsPatient.Email & "','" & clsPatient.DL & " ','" _
                & PsUserID & "', '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "','" & clsPatient.Blood_Type & "'," & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        If IsProperCase(clsPatient.Status) = "Active" Then
            strSQL = "UPDATE Patient Set PURGE = 0 WHERE PATIENT_ID = " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        mbNotSave = False
        strSQL = "Update_Patient_Table_Update_Date '" & Format(Now, "mm/dd/yyyy hh:mm:ss AM/PM") & "'," & piPatientID
        Set rsPatient = cnPatient.Execute(strSQL)
        If Trim(cboLanguage.Text) <> vbNullString Then
            clsPatient.Language = Trim(cboLanguage.Text)
            strSQL = "Update_Patient_Table_Language '" & clsPatient.Language & "'," & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        If Trim(cboPrefContact.Text) <> vbNullString Then
            clsPatient.PrefContact = Trim(cboPrefContact.Text)
            strSQL = "Update_Patient_Table_Pref_Contact '" & clsPatient.PrefContact & "'," & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        If Trim(cboStatus.Text) <> vbNullString Then
            clsPatient.Status = Trim(cboStatus.Text)
            strSQL = "Update_Patient_Table_Status  '" & clsPatient.Status & "'," & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
        If Not IsNull(ccdDateDeath.Value) And ccdDateDeath.CheckBox Then
            clsPatient.DateDeath = Format(ccdDateDeath.Value, "mm/dd/yyyy")
            strSQL = "Update_Patient_Date_Death '" & clsPatient.DateDeath & "', " & piPatientID
            Set rsPatient = cnPatient.Execute(strSQL)
        End If
...
Private Sub Screen_Action()
    ...
    cmdName.Enabled = bEnable
    cmdAddress.Enabled = bEnable
...
Dim fso As New FileSystemObject
    ...
    If cboLanguage.listcount <= 0 Then GetTerms cboLanguage, "sd_Patient_Language"
    If cboPatientRace.listcount <= 0 Then GetTerms cboPatientRace, "sd_Patient_Race"
    If cnPatient.State = adStateClosed Then cnPatient.open psConnect(0)
    strSQL = "Get_Patient_BY_Id " & piPatientID
    Set rsPatient = cnPatient.Execute(strSQL)
    If Not rsPatient.EOF Then
                    ...
                    Select Case UCase(Fld.Name)
                        ...
                        Case "LAST_NAME"
                            ...
                            If TextFound("''", clsPatient.LastName, 2, True) Then
                                clsPatient.LastName = Replace(clsPatient.LastName, "''", "'")
                                clsPatient.LastName = clsPatient.LastName
                            Else
                                clsPatient.LastName = clsPatient.LastName
                            End If
                        Case "GENDER"
                            clsPatient.Gender = IsProperCase(Fld.Value)
                            If Left(IsProperCase(clsPatient.Gender), 1) = "F" Then
                                clsPatient.Gender = "Female"
                                clsPatient.Person = "She"
                                clsPatient.Possessive = "Her"
                                clsPatient.PerPosses = "Herself"
                            ElseIf Left(IsProperCase(clsPatient.Gender), 1) = "M" Then
                                clsPatient.Gender = "Male"
                                clsPatient.Person = "He"
                                clsPatient.Possessive = "His"
                                clsPatient.PerPosses = "Himself"
                            End If
                        Case "TITLE"
...
'                            txtEmergContact.Text = clsPatient.EmergContact
                        Case "STATUS"
                            ...
                            For i = 0 To cboStatus.listcount - 1
                                If IsProperCase(cboStatus.List(i)) = IsProperCase(clsPatient.Status) Then
...
'                            End If
                        ...
                        Case "PREF_CONTACT"
                            ...
                            For i = 0 To cboPrefContact.listcount - 1
                                If IsProperCase(cboPrefContact.List(i)) = IsProperCase(clsPatient.PrefContact) Then
                        ...
                        Case "LANGUAGE"
                            ...
                            Next
                        Case "ETHNICITY"
                            clsPatient.Ethnicity = IsProperCase(Fld.Value)
                            For i = 0 To cboEthinicity.listcount - 1
                                If TextFound(clsPatient.Ethnicity, cboEthinicity.List(i), Len(clsPatient.Ethnicity), True) Then
                                    cboEthinicity.Text = cboEthinicity.List(i)
                                    Exit For
                                End If
                            Next
                            '
    ...
    If clsPatient.Phone <> vbNullString Then
        ...
        Else
           txtPhone1.Text = Left(clsPatient.Phone, 3)
           txtPhone2.Text = Right(clsPatient.Phone, 4)
        End If
    Else
        txtAreaCode.Text = vbNullString
        txtPhone1.Text = vbNullString
    ...
    If Trim(clsPatient.WorkPhone) <> vbNullString Then
        ...
        End If
    End If
    If Trim(clsPatient.ExtID) <> vbNullString Then pxPatientID = clsPatient.ExtID & ""
    ...
    If Left(IsProperCase(clsPatient.Gender), 1) = "M" Then
        clsPatient.Title = "Mr."
    ElseIf Left(IsProperCase(clsPatient.Gender), 1) = "F" Then
        If IsProperCase(clsPatient.Marital_Status) = "Married" Then
    ...
    If Trim(clsPatient.City) <> vbNullString Then txtAddress.Text = Trim(txtAddress.Text) & vbNewLine & Trim(clsPatient.CityStateZip)
    ...
    mbooByPass = True
    If Left(clsPatient.Gender, 1) = "M" Then
        optMale.Value = True
        optFemale.Value = False
    ElseIf Left(clsPatient.Gender, 1) = "F" Then
    ...
    clsEmerg.Name = Replace(clsEmerg.Name, "''", "'")
    ...
    If Val(txtAge.Text) <= 18 And mstrPractice = "Psychiatry" Then
        lblPartnerName.Caption = "Parent or Guardian"
        lblPartTitle.Caption = "PARENT OR GUARDIAN"
    End If
    Get_Bill_Facility
    Load_Facilities
    If cboFacility.listcount > 0 Then
    ...
    If cboFacility.listcount > 0 Then
        ...
        Next i
    End If
    If clsFacStatus.FacilityID > 0 Then Get_Room_Number
    If Trim(clsFacStatus.StatusDesc) <> vbNullString Then
        cctStatusNote.Text = Trim(clsFacStatus.StatusDesc)
    End If
    cboFacStatus.Locked = True
...
Dim strSuffix As String
    ...
    If mNewPatient Then
        Dump_PatientStrData
    End If
    strHoldName = txtFullName.Text
    If Trim(clsPatient.Title) <> vbNullString Then strTitle = Trim(clsPatient.Title)
    If Trim(clsPatient.FirstName) <> vbNullString Then strFirst = Trim(clsPatient.FirstName)
    If Trim(clsPatient.MiddleName) <> vbNullString Then strMiddle = Trim(clsPatient.MiddleName)
    If Trim(clsPatient.LastName) <> vbNullString Then strLast = Trim(clsPatient.LastName)
    If Trim(clsPatient.Suffix) <> vbNullString Then strSuffix = Trim(clsPatient.Suffix)
    txtFullName.Text = vbNullString
    frmPatientName.Show vbModal
    If Trim(clsPatient.Title) <> vbNullString Then
        txtFullName.Text = Trim(clsPatient.Title)
    End If
    If Trim(clsPatient.FirstName) <> vbNullString Then
        txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.FirstName)
        If Trim(clsPatient.MiddleName) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.MiddleName)
        If Trim(clsPatient.LastName) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.LastName)
        If Trim(clsPatient.Suffix) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & ", " & Trim(clsPatient.Suffix)
    ...
    Else
        If Trim(strTitle) <> vbNullString Then clsPatient.Title = strTitle
        If Trim(strFirst) <> vbNullString Then clsPatient.FirstName = strFirst
        If Trim(strMiddle) <> vbNullString Then clsPatient.MiddleName = strMiddle
        If Trim(strLast) <> vbNullString Then clsPatient.LastName = Trim(strLast)
        If Trim(strSuffix) <> vbNullString Then clsPatient.Suffix = Trim(strSuffix)
        txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.FirstName)
        If Trim(clsPatient.MiddleName) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.MiddleName)
        If Trim(clsPatient.LastName) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & " " & Trim(clsPatient.LastName)
        If Trim(clsPatient.Suffix) <> vbNullString Then txtFullName.Text = Trim(txtFullName.Text) & ", " & Trim(clsPatient.Suffix)
...
Private Sub txtFullName_KeyDown(KeyCode As Integer, Shift As Integer)
        ...
        If clsPatient.FirstName <> vbNullString Then
            txtFullName.Text = Trim(clsPatient.Title) & " " & Trim(clsPatient.FirstName) & " " & Trim(clsPatient.MiddleName) & " " & Trim(clsPatient.LastName) & ", " & Trim(clsPatient.Suffix)
        End If
    Exit Sub
End Sub
