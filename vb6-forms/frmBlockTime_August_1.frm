...
Begin VB.Form frmBlockTime 
   ...
   Begin VB.Frame fraSchedConflicts 
      ...
      Begin PT_XP_Button.PT_XP cmdExit 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmBlockTime.frx":6F30
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPrintList 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmBlockTime.frx":781C
         ShowFocus       =   -1  'True
      End
   End
   ...
   Begin PT_XP_Button.PT_XP cmdDurationBlock 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmBlockTime.frx":7B6E
      BackColorDown   =   15133676
      TransparentColor=   14215660
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmBlockTime.frx":8108
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cboReasonTerms 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmBlockTime.frx":845A
      AppearanceThemes=   3
      TransparentColor=   14215660
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmBlockTime.frx":89F4
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdClose 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":9758
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdSaveBlock 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":A044
      ShowFocus       =   -1  'True
   End
   Begin FPSpreadADO.fpSpread grdBlock 
      ...
      ShadowDark      =   8388608
      ShadowText      =   8388608
      SpreadDesigner  =   "frmBlockTime.frx":A396
      UserResize      =   0
      Appearance      =   1
      ClipboardOptions=   0
      CellNoteIndicator=   3
   ...
   Begin PT_XP_Button.PT_XP cmdRemoveRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":AE31
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdGridRow 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":B71D
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdPrint 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":C009
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdDate 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":C8F5
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdSelectAll 
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmBlockTime.frx":D1E1
      ShowFocus       =   -1  'True
   End
...
Dim lngProv As Long
    ...
    If cnBlock.State = adStateClosed Then cnBlock.open psConnect(1)
    strSQL = "Read_BlockTime_ProviderID_Date " & lngProv & ", '" & Format(udtTime.StartDate, "mm/dd/yyyy") & "' , '" & Format(udtTime.EndDate, "mm/dd/yyyy") & "'"
...
'            & "WHERE CONVERT(DATETIME, APPOINTMENTS.APPT_DATE, 101) BETWEEN '" & Format(strStartDate, "mm/dd/yyyy") & "' AND '" & Format(strEndDate, "mm/dd/yyyy") & "' AND " _
...
'            & "APPOINTMENTS.PATIENT_ID, PATIENT.LAST_NAME, APPOINTMENTS.APPT_DATE DESC "
    ...
    Else
        strSQL = "Block_Check_Provider_Conflict_Date  " & udtBlock.ProviderID & ",  " & udtBlock.FacilityID & ",'" _
            ...
            & Format(strEndTime, "hh:mm AM/PM") & "'"
'        strSQL = "SELECT APPOINTMENTS.*, PATIENT.LAST_NAME  FROM APPOINTMENTS INNER JOIN PATIENT ON APPOINTMENTS.PATIENT_ID = PATIENT.PATIENT_ID " _
'            & "WHERE CONVERT(DATETIME, APPOINTMENTS.APPT_DATE, 101) = '" & Format(strStartDate, "mm/dd/yyyy") & "' AND " _
'            & "APPOINTMENTS.PROVIDER_ID = " & udtBlock.ProviderID & " AND APPOINTMENTS.FACILITY_ID = " & udtBlock.FacilityID & " AND " _
...
Dim Idx%
    ...
    Screen.MousePointer = vbHourglass
     clsGridFormat.List = vbNullString
    If cnMedProv.State = adStateClosed Then cnMedProv.open psConnect(0)
    strSQL = "Get_Appt_Providers " & udtBlock.FacilityID
     Set rsMedProv = cnMedProv.Execute(strSQL)
    With rsMedProv
        Do Until .EOF
            strFirst = vbNullString
...
Dim strTerms As String
    ...
    clsGridFormat.List = vbNullString
    If cnTerms.State = adStateClosed Then cnTerms.open psConnect(1)
    strSQL = "Get_Attr_Valid_Value_SubDom_Sequence '" & vstrSubDomain & "'"
    Set rsTerms = cnTerms.Execute(strSQL)
    With rsTerms
        Do Until rsTerms.EOF
            strTerms = vbNullString
            If Not IsNull((!ATTRBTE_VALID_VALUE)) Then
            strTerms = IsProperCase((!ATTRBTE_VALID_VALUE))
            End If
            .MoveNext
            If Get_GridTerms = vbNullString Then
                Get_GridTerms = strTerms
            ElseIf Not TextFound(strTerms, Get_GridTerms, Len(strTerms), True) Then
                Get_GridTerms = Get_GridTerms & Chr(9) & strTerms
            End If
        Loop
    End With
