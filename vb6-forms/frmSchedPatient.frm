...
Begin VB.Form frmSchedPatient 
   ...
   Begin LpADOLib.fpComboAdo fpTerm 
      ...
      EditAlignV      =   0
      AllowAnimate    =   -1  'True
      ColDesigner     =   "frmSchedPatient.frx":058A
   End
   Begin TabDlg.SSTab ssTab 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "Patient Select"
      TabPicture(0)   =   "frmSchedPatient.frx":084D
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "fraPic"
      Tab(0).Control(1)=   "cctFacility"
      Tab(0).Control(2)=   "lstListBox"
      Tab(0).Control(3)=   "cctSearch"
      Tab(0).Control(4)=   "cboProvider"
      Tab(0).Control(5)=   "cboApptType"
      Tab(0).Control(6)=   "cboSchedResource"
      Tab(0).Control(7)=   "cmdPageNext"
      Tab(0).Control(8)=   "cmdAcct"
      Tab(0).Control(9)=   "lblWorkPhone"
      Tab(0).Control(10)=   "lblCell2"
      Tab(0).Control(11)=   "lblPhone2"
      Tab(0).Control(12)=   "lblFrontPName"
      Tab(0).Control(13)=   "lblFrontID"
      Tab(0).Control(14)=   "lblPatient"
      Tab(0).Control(15)=   "Label5"
      Tab(0).Control(16)=   "lblPhone1"
      Tab(0).Control(17)=   "lblCell1"
      Tab(0).Control(18)=   "Label3"
      Tab(0).Control(19)=   "lblAddress"
      Tab(0).Control(20)=   "lblPatInfo"
      Tab(0).Control(21)=   "lblProvider"
      Tab(0).Control(22)=   "lblApptType"
      Tab(0).Control(23)=   "Label6"
      Tab(0).Control(24)=   "lblFac"
      Tab(0).Control(25)=   "imgPatient"
      Tab(0).ControlCount=   26
      TabCaption(1)   =   "Schedule Appointment"
      TabPicture(1)   =   "frmSchedPatient.frx":0869
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "ccdTime"
      Tab(1).Control(1)=   "fraRefer"
      Tab(1).Control(2)=   "cctReferalReas"
      Tab(1).Control(3)=   "cboDuration"
      Tab(1).Control(4)=   "txtComments"
      Tab(1).Control(5)=   "cboReferBy"
      Tab(1).Control(6)=   "cboStatus"
      Tab(1).Control(7)=   "cboReason"
      Tab(1).Control(8)=   "cboFacility"
      Tab(1).Control(9)=   "cboPatientType"
      Tab(1).Control(10)=   "cboSerPlace"
      Tab(1).Control(11)=   "cmdApply"
      Tab(1).Control(12)=   "txtApptConfirm"
      Tab(1).Control(13)=   "txtDate"
      Tab(1).Control(14)=   "cmdRepeat"
      Tab(1).Control(15)=   "cmdShowAll"
      Tab(1).Control(16)=   "cmdPhyPlan"
      Tab(1).Control(17)=   "cmdSeeAvail"
      Tab(1).Control(18)=   "cmdStatus"
      Tab(1).Control(19)=   "cmdReason"
      Tab(1).Control(20)=   "cmdRefReason"
      Tab(1).Control(21)=   "cmdChange"
      Tab(1).Control(22)=   "grdProcedure"
      Tab(1).Control(23)=   "fraPsycho"
      Tab(1).Control(24)=   "cmdClose"
      Tab(1).Control(25)=   "lblName2"
      Tab(1).Control(26)=   "lblAppt2"
      Tab(1).Control(27)=   "lblReasRefer"
      Tab(1).Control(28)=   "Label1"
      Tab(1).Control(29)=   "lblReferral"
      Tab(1).Control(30)=   "lblDuration"
      Tab(1).Control(31)=   "lblFacility"
      Tab(1).Control(32)=   "lblTime"
      Tab(1).Control(33)=   "lblADate"
      Tab(1).Control(34)=   "lblID1"
      Tab(1).Control(35)=   "lblID2"
      Tab(1).Control(36)=   "lblName1"
      Tab(1).Control(37)=   "lblStatus"
      Tab(1).Control(38)=   "lblReason"
      Tab(1).Control(39)=   "lblConfirm"
      Tab(1).Control(40)=   "Label2"
      Tab(1).Control(41)=   "lblPatientType"
      Tab(1).Control(42)=   "lblPatType"
      Tab(1).Control(43)=   "lblPurposeVisit"
      Tab(1).Control(44)=   "lblCPT"
      Tab(1).Control(45)=   "lblCode"
      Tab(1).Control(46)=   "lblAppt1"
      Tab(1).ControlCount=   47
      TabCaption(2)   =   "Available Appointments"
      TabPicture(2)   =   "frmSchedPatient.frx":0885
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ccSchedDate"
      Tab(2).Control(1)=   "grdAvailAppt"
      Tab(2).Control(2)=   "cmdSelectAvail"
      Tab(2).ControlCount=   3
      TabCaption(3)   =   "Manage Appointment"
      TabPicture(3)   =   "frmSchedPatient.frx":08A1
      Tab(3).ControlEnabled=   -1  'True
      Tab(3).Control(0)=   "lblPrevApptDate"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "cmdManClose"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "cmdPrint"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "ccdRevisedDate"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "cmdUpdate"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "grdAppointChange"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "cmdRemoveRow"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).ControlCount=   7
      Begin VB.ComboBox ccdTime 
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   11.25
            Charset         =   0
      ...
      Begin VB.Frame fraRefer 
         ...
         Begin PT_XP_Button.PT_XP cmdRefClose 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":08BD
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close "
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":12CF
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdRefTerms 
            ...
            EndProperty
            MaskColor       =   128
            Picture         =   "frmSchedPatient.frx":1621
            AppearanceThemes=   3
            BorderWidth     =   2
            TransparentColor=   14737632
            Caption         =   ".."
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":1BBB
            ShowFocus       =   -1  'True
         End
      ...
      Begin VB.ComboBox cboReferBy 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":1F0D
         Left            =   -65145
         List            =   "frmSchedPatient.frx":1F0F
         Style           =   2  'Dropdown List
         TabIndex        =   71
         Top             =   3440
         Width           =   3285
      ...
      Begin VB.ComboBox cboStatus 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":1F11
         Left            =   -65145
         List            =   "frmSchedPatient.frx":1F13
         Style           =   2  'Dropdown List
         TabIndex        =   33
         Top             =   1700
         Width           =   3285
      ...
      Begin VB.ComboBox cboFacility 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmSchedPatient.frx":1F15
         Left            =   -72405
         List            =   "frmSchedPatient.frx":1F17
         Style           =   2  'Dropdown List
         TabIndex        =   31
         Top             =   2060
         Width           =   4335
      ...
      Begin VB.ComboBox cboSerPlace 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":1F19
         Left            =   -71820
         List            =   "frmSchedPatient.frx":1F1B
         Style           =   2  'Dropdown List
         TabIndex        =   27
      ...
      Begin VB.ListBox lstListBox 
         ...
         EndProperty
         Height          =   780
         ItemData        =   "frmSchedPatient.frx":1F1D
         Left            =   -74670
         List            =   "frmSchedPatient.frx":1F1F
         Sorted          =   -1  'True
         Style           =   1  'Checkbox
         TabIndex        =   14
         Top             =   2240
      ...
      Begin VB.ComboBox cboApptType 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmSchedPatient.frx":1F21
         Left            =   -72750
         List            =   "frmSchedPatient.frx":1F37
         Style           =   2  'Dropdown List
         TabIndex        =   11
         Top             =   710
         Width           =   2970
      ...
      Begin PT_XP_Button.PT_XP cmdApply 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":1F71
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "&Apply"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":230B
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdRepeat 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":265D
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":2BF7
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdShowAll 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":2F49
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Change Appt"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":34E3
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPhyPlan 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":3835
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":3DCF
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdSeeAvail 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":4121
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Available"
         DefaultThemes   =   2
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":46BB
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdStatus 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":4A0D
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":4FA7
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":52F9
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":5893
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRefReason 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":5BE5
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   ""
         DepthEvent      =   1
         PictureDisabled =   "frmSchedPatient.frx":617F
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdChange 
         ...
         EndProperty
         MaskColor       =   128
         Picture         =   "frmSchedPatient.frx":64D1
         AppearanceThemes=   3
         BorderWidth     =   2
         TransparentColor=   14737632
         Caption         =   ""
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":6A6B
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdPageNext 
         Height          =   345
         Left            =   -68437
         TabIndex        =   79
         Top             =   7545
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":6DBD
         ShowFocus       =   -1  'True
      End
      Begin FPSpreadADO.fpSpread grdProcedure 
         ...
         ShadowDark      =   8388608
         ShadowText      =   8388608
         SpreadDesigner  =   "frmSchedPatient.frx":74CF
         UserResize      =   0
         Appearance      =   2
         TextTip         =   4
         TextTipDelay    =   100
      ...
      Begin VB.Frame fraPsycho 
         ...
         Begin FPSpreadADO.fpSpread grdPsychotherapy 
            ...
            ShadowDark      =   8388608
            ShadowText      =   8388608
            SpreadDesigner  =   "frmSchedPatient.frx":79D1
            UserResize      =   0
            Appearance      =   2
            ClipboardOptions=   0
         End
         Begin PT_XP_Button.PT_XP cmdPsyAdd 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":7EC0
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Select"
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":825A
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdPsyClose 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":85AC
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Close"
            DepthEvent      =   1
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":8FBE
            ShowFocus       =   -1  'True
         End
         Begin PT_XP_Button.PT_XP cmdRemAddOn 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "frmSchedPatient.frx":9310
            AppearanceThemes=   3
            TransparentColor=   14737632
            Caption         =   "Remove"
            DefaultThemes   =   2
            ...
            ForeColorFocus  =   8388608
            ForeColorDown   =   8388608
            PictureDisabled =   "frmSchedPatient.frx":98AA
            ShowFocus       =   -1  'True
         End
      End
      Begin PT_XP_Button.PT_XP cmdAcct 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":9BFC
         AppearanceThemes=   3
         BorderDrawEvent =   1
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":A196
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":A4E8
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":AEFA
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdRemoveRow 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":B24C
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":B7E6
         ShowFocus       =   -1  'True
      End
      Begin FPSpreadADO.fpSpread grdAppointChange 
         ...
         ShadowDark      =   8388608
         ShadowText      =   0
         SpreadDesigner  =   "frmSchedPatient.frx":BB38
         UserResize      =   0
         Appearance      =   2
         ClipboardOptions=   0
         CellNoteIndicator=   3
      ...
      Begin PT_XP_Button.PT_XP cmdUpdate 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":C041
         AppearanceThemes=   3
         TransparentColor=   14737632
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":C5DB
         ShowFocus       =   -1  'True
      End
      ...
      Begin PT_XP_Button.PT_XP cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":C92D
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Print"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":CEC7
         ShowFocus       =   -1  'True
      End
      Begin PT_XP_Button.PT_XP cmdManClose 
         Height          =   345
         Left            =   6668
         TabIndex        =   99
         Top             =   7410
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":D219
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":DC2B
         ShowFocus       =   -1  'True
      End
      ...
      Begin FPSpreadADO.fpSpread grdAvailAppt 
         ...
         ShadowDark      =   8388608
         ShadowText      =   8388608
         SpreadDesigner  =   "frmSchedPatient.frx":DF7D
         UserResize      =   0
         Appearance      =   2
         TextTipDelay    =   100
         ScrollBarTrack  =   1
      ...
      Begin PT_XP_Button.PT_XP cmdSelectAvail 
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":E498
         ShowFocus       =   -1  'True
      End
   ...
   Begin VB.Frame fraPlan 
      ...
      Begin FPSpreadADO.fpSpread grdPlan 
         ...
         ShadowDark      =   8388608
         ShadowText      =   4194304
         SpreadDesigner  =   "frmSchedPatient.frx":E7EA
         UnitType        =   0
         UserResize      =   0
         Appearance      =   2
         TextTipDelay    =   50
      ...
      Begin PT_XP_Button.PT_XP cmdPlan 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmSchedPatient.frx":ED2E
         AppearanceThemes=   3
         TransparentColor=   14737632
         Caption         =   "Close"
         DepthEvent      =   1
         ...
         ForeColorFocus  =   8388608
         ForeColorDown   =   8388608
         PictureDisabled =   "frmSchedPatient.frx":F740
         ShowFocus       =   -1  'True
      End
   End
   Begin PT_XP_Button.PT_XP cmdEditPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":FA92
      AppearanceThemes=   3
      TransparentColor=   14737632
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":1002C
      ShowFocus       =   -1  'True
   End
   Begin PT_XP_Button.PT_XP cmdTakePic 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":1037E
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   ""
      DepthEvent      =   1
      PictureDisabled =   "frmSchedPatient.frx":10C58
      ShowFocus       =   -1  'True
   End
   ...
   Begin PT_XP_Button.PT_XP cmdNewPatient 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmSchedPatient.frx":118AA
      AppearanceThemes=   3
      TransparentColor=   14737632
      Caption         =   "New Patient"
      CaptionAlignment=   5
      ...
      ForeColorFocus  =   8388608
      ForeColorDown   =   8388608
      PictureDisabled =   "frmSchedPatient.frx":11E44
      ShowFocus       =   -1  'True
   End
...
Dim i%
    ...
    If vstrTime = vbNullString Then
        strTime = ccdTime.Text
        strTime = Format(strTime, "nn")
        strTime = DateAdd("n", Format(strTime, "nn") + 1, ccdTime.Text)
        sValue = Replace((clsWriteAppt.Duration), "minutes", "")
        sValue = DateAdd("n", Val(sValue) - 1, ccdTime.Text)
...
Dim strDuration As String
    ...
    With grdProcedure
        If IsProperCase(udtAppointment.SchedType) = "Patient" Or udtAppointment.SchedType = vbNullString Then
            ...
            clsWriteAppt.SchedTime = Format(ccdTime.Text, "hh:mm AM/PM")
    ...
    If udtAppointment.FacilityID = 0 Then
        For i = 0 To cboFacility.listcount - 1
           If cboFacility.ItemData(i) = udtFacility.FacID Then
                ...
                udtAppointment.FacilityID = cboFacility.ItemData(i)
               Exit For
           End If
        Next i
    End If
            ...
            Do Until .EOF
                ...
                If strTestDur <> vbNullString Then
                    ...
                    If Format(udtAppointment.SchedTime, "hh:mm AM/PM") >= Format(strTestTime, "hh:mm AM/PM") And Format(udtAppointment.SchedTime, "hh:mm AM/PM") <= Format(strTestEnd, "hh:mm AM/PM") Then
                        ...
                        Set_TimeField Format(udtAppointment.SchedTime, "hh:mm AM/PM")
...
Private Sub Clear_Fields()
    ...
    lblFrontPName.Caption = vbNullString
    lblFrontID.Caption = vbNullString
    lblFrontPName.Caption = vbNullString
    cboReferBy.Clear
...
Dim Idx As Integer
    ...
    Set_TimeField Format(Now, "hh:mm AM/PM")
...
'    End If
    ...
    If udtAppointment.SchedTime = vbNullString Then
         udtAppointment.SchedTime = Format(ccdTime.Text, "hh:mm AM/PM")
    End If
...
Dim lngRow As Long
   ...
   ' fraInfo.Visible = True
    ...
    lblFrontID.Caption = udtSchedPatient.IntId
    lblName2.Caption = Trim(udtSchedPatient.FirstName) & " " & Trim(udtSchedPatient.LastName)
    lblFrontPName.Caption = Trim(udtSchedPatient.FirstName) & " " & Trim(udtSchedPatient.LastName)
...
Private Function Set_TimeField(vstrTime As String)
Dim Idx%
Dim dBfound As Boolean
Dim ArrStart
Dim ArrEnd

    For Idx = 0 To ccdTime.listcount - 1
        If ccdTime.List(Idx) = vstrTime Then
            ccdTime.Text = ccdTime.List(Idx)
            dBfound = True
            Exit For
        End If
    Next Idx
    If Not dBfound Then
        For Idx = 0 To ccdTime.listcount - 1
            If DateDiff("n", Format(vstrTime, "hh:mm AM/PM"), Format(ccdTime.List(Idx), "hh:mm AM/PM")) > 0 Then
                ccdTime.Text = ccdTime.List(Idx)
                dBfound = True
                Exit For
            End If
...
Dim strEndDate As String
    ...
    End If
    If ccdTime <> vbNullString Then strTime = ccdTime
...
Private Sub cboReferBy_Click()
  If mbooByPass Then mbooByPass = False: Exit Sub
    If IsProperCase(cboReferBy.Text) = "Doctor" Then
...
Dim Arr
    ...
    If Trim(ccdTime.Text) = vbNullString Then
...
Dim lngPat As Long
    ...
    With grdAppointChange
        ...
        .ColWidth(6) = 10
        .ColWidth(7) = 20
        lngPat = Val(udtSchedPatient.IntId)
        If Trim(udtSchedPatient.IntId) <> vbNullString Then
            Select Case IsProperCase(udtAppointment.SchedType)
                Case "Patient"
                    Get_SchedPatient Val(udtSchedPatient.IntId)
        ...
        .Redraw = True
    End With
    udtSchedPatient.IntId = CStr(lngPat)
    Screen.MousePointer = vbDefault
    Exit Sub
Error_Format_Grid:
    Screen.MousePointer = vbDefault
    ...
    If cctReferral.Text <> vbNullString Then
        ...
        If clsReferral.ReferralID > 0 Then
            For i = 0 To cboReferBy.listcount - 1
                If cboReferBy.List(i) = cctReferral.Text Then
...
Dim varCellValue
    ...
    For lngRow = 1 To grdProcedure.MaxRows
        ...
        End With
    Next lngRow
    If Not IsNull(ccdTime.Text) <> vbNullString Then udtRepeatAppt.StartTime = Format(ccdTime.Text, "hh:mm AM/PM")
...
Dim i%
    ...
    If Not Check_OverBook_Change(clsWriteAppt.SchedTime) Then
        ...
        Set_TimeField clsWriteAppt.SchedTime
        SSTab.Tab = 1
    End If
    Exit Sub
End Sub
...
Dim Arr
    ...
    End If
    ccdTime.Clear
    Arr = Split(Load_TimeGrid, Chr(9))
    If UBound(Arr) > 0 Then
        For Idx = LBound(Arr) To UBound(Arr)
            If Trim(Arr(Idx)) <> vbNullString Then
                ccdTime.AddItem Trim(Arr(Idx))
            End If
        Next Idx
    End If
    lblCode.Caption = vbNullString
    ...
    If mbLookupPatient And Val(udtSchedPatient.IntId) <> 0 Then
       ...
       If IsProperCase(udtAppointment.SchedType) = "Patient" Then
          ...
          lblFrontPName.Caption = udtSchedPatient.FirstName & " " & Left(udtSchedPatient.MiddleInitial, 1) _
                           & " " & udtSchedPatient.LastName
          lblFrontID.Caption = udtSchedPatient.IntId
          ...
          End If
          If udtSchedPatient.Suffix <> vbNullString Then
             lblFrontPName.Caption = lblName2.Caption & ", " & udtSchedPatient.Suffix
          End If
          If udtSchedPatient.title <> vbNullString Then
             lblFrontPName.Caption = lblName2.Caption & ", " & UCase(udtSchedPatient.title)
          End If
       End If
...
Dim strRange As String
    ...
    If ccdTime <> vbNullString Then strTime = ccdTime.Text
    strRange = DateAdd("d", -7, udtAppointment.SchedDate)
    If Trim(strTime) = vbNullString Then
        Screen.MousePointer = vbDefault
        Exit Function
