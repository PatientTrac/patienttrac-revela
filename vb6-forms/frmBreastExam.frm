...
Begin VB.Form frmBreastExam 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0E0E0&
   Caption         =   "Breast Examination"
   ClientHeight    =   10485
   ClientLeft      =   3240
   ClientTop       =   2520
   ClientWidth     =   14220
   ...
   EndProperty
   ForeColor       =   &H00800000&
   Icon            =   "frmBreastExam.frx":0000
   ScaleHeight     =   12738.04
   ScaleMode       =   0  'User
   ScaleWidth      =   14220
   ...
   End
End
Attribute VB_Name = "frmBreastExam"
...
Private Sub Load_BreastExam()
Dim strOCX As String
Dim strControl As String
Dim intACTXID As Integer
Dim strRemarks As String

    On Error GoTo Error_Load_BreastExam
    ...
    strOCX = "FN_BreastExam"
    strControl = "BreastMeasSim"
    
    intACTXID = Get_ComponentID(strOCX, strControl)
    
    Licenses.Add strOCX & "." & strControl
    Set fobjOCX = Controls.Add(strOCX & "." & strControl, "ctlBreastMeasSim", Me)
        fobjOCX.Visible = True
        fobjOCX.Left = 150
        fobjOCX.Top = 700
        'fraControlPanel.Left = fobjOCX.Width + 125
        frmBreastExam.Width = fobjOCX.Width + 300
       ...
       ' frmBreastExam.Height = fobjOCX.Height * 1.5
    Exit Sub
    
Error_Load_BreastExam:
    ...
    ErrHandler _
     "frmBreastExam.Load_BreastExam", _
     Err.Number, _
     Err.Description
     Screen.MousePointer = vbDefault
     Exit Sub
...
Private Sub Form_Load()
    ...
    LogFile "Start Log  BreastExam --------------------", True
 
        Load_BreastExam
    frmBreastExam.Caption = " Patient: " & UCase(clsPatient.Name)
    Screen.MousePointer = vbDefault
...
Private Sub Form_Resize()
  ...
  ' frmBreastExam.Top = 500
    'frmmdi.Height =
  '  frmBreastExam.Height = 11000
   ' centerForm Me
End Sub
